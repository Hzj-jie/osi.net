...
Public Module _environment_transform
        ...
        Else
            ...
            For j As Int32 = 0 To array_size(i) - 1
                If Not i(j) Is Nothing Then
                    r(j) = emplace_make_pair(i(j).first.env_transform(start_str, end_str),
    ...
    <Extension()> Public Function env_transform(ByVal i As vector(Of pair(Of String, String)),
        ...
        Else
            ...
            For j As Int32 = 0 To i.size() - 1
                If Not i(j) Is Nothing Then
                    r.emplace_back(emplace_make_pair(i(j).first.env_transform(start_str, end_str),
                                                     i(j).second.env_transform(start_str, end_str)))
                End If
            Next
            Return r
