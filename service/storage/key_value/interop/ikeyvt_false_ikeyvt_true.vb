...
Friend Class ikeyvt_false_ikeyvt_true
    ...
    Public Function append(ByVal key() As Byte,
                           ByVal value() As Byte,
                           ByVal ts As Int64,
                           ByVal result As pointer(Of Boolean)) As event_comb Implements ikeyvt(Of _true).append
        Return l.locked(Function() impl.append(key, value, ts, result))
    End Function

    Public Function capacity(ByVal result As pointer(Of Int64)) As event_comb Implements ikeyvt(Of _true).capacity
        Return l.locked(Function() impl.capacity(result))
    End Function

    Public Function delete(ByVal key() As Byte,
                           ByVal result As pointer(Of Boolean)) As event_comb Implements ikeyvt(Of _true).delete
        Return l.locked(Function() impl.delete(key, result))
    End Function

    Public Function empty(ByVal result As pointer(Of Boolean)) As event_comb Implements ikeyvt(Of _true).empty
        Return l.locked(Function() impl.empty(result))
    End Function

    Public Function full(ByVal result As pointer(Of Boolean)) As event_comb Implements ikeyvt(Of _true).full
    ...
    Public Function keycount(ByVal result As pointer(Of Int64)) As event_comb Implements ikeyvt(Of _true).keycount
        Return l.locked(Function() impl.keycount(result))
    End Function

    Public Function list(ByVal result As pointer(Of vector(Of Byte()))) As event_comb Implements ikeyvt(Of _true).list
    ...
    Public Function modify(ByVal key() As Byte,
                           ByVal value() As Byte,
                           ByVal ts As Int64,
                           ByVal result As pointer(Of Boolean)) As event_comb Implements ikeyvt(Of _true).modify
    ...
    Public Function read(ByVal key() As Byte,
                         ...
                         ByVal ts As pointer(Of Int64)) As event_comb Implements ikeyvt(Of _true).read
    ...
    Public Function seek(ByVal key() As Byte,
                         ByVal result As pointer(Of Boolean)) As event_comb Implements ikeyvt(Of _true).seek
        Return l.locked(Function() impl.seek(key, result))
    End Function

    Public Function sizeof(ByVal key() As Byte,
                           ByVal result As pointer(Of Int64)) As event_comb Implements ikeyvt(Of _true).sizeof
    ...
    Public Function valuesize(ByVal result As pointer(Of Int64)) As event_comb Implements ikeyvt(Of _true).valuesize
