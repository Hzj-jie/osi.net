...
Partial Public Class file_index
    ...
    Public Function empty(ByVal result As pointer(Of Boolean)) As event_comb Implements ikeyvt2(Of atom).empty
    ...
    Public Function keycount(ByVal result As pointer(Of Int64)) As event_comb Implements ikeyvt2(Of atom).keycount
        Return half_keycount(AddressOf index.keycount, result)
    End Function

    Public Function list(ByVal result As pointer(Of vector(Of Byte()))) As event_comb Implements ikeyvt2(Of atom).list
    ...
    Public Function seek(ByVal key() As Byte,
                         ByVal r As pointer(Of atom),
                         ByVal result As pointer(Of Boolean)) As event_comb Implements ikeyvt2(Of atom).seek
        Dim ec As event_comb = Nothing
        Return New event_comb(Function() As Boolean
    ...
    Public Function valuesize(ByVal result As pointer(Of Int64)) As event_comb Implements ikeyvt2(Of atom).valuesize
        Return directory_size(dr.base_directory(), result)
    End Function

    Public Function write_new(ByVal key() As Byte,
                              ByVal value() As Byte,
                              ByVal result As pointer(Of Boolean)) As event_comb Implements ikeyvt2(Of atom).write_new
        Dim fn As pointer(Of String) = Nothing
        Dim ec As event_comb = Nothing
        Return New event_comb(Function() As Boolean
                                  fn = New pointer(Of String)()
                                  ec = new_filename(fn)
                                  Return waitfor(ec) AndAlso
                                         goto_next()
                              End Function,
