...
Public Interface ikeyvt(Of THREADSAFE As _boolean)
    ...
    Function delete(ByVal key() As Byte, ByVal result As pointer(Of Boolean)) As event_comb

    'if the key & value & timestamp exist
    Function seek(ByVal key() As Byte, ByVal result As pointer(Of Boolean)) As event_comb
    ...
    Function sizeof(ByVal key() As Byte, ByVal result As pointer(Of Int64)) As event_comb
