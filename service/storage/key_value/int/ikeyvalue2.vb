...
Public Interface ikeyvalue2(Of SEEK_RESULT)
    Function read_existing(ByVal r As SEEK_RESULT, ByVal value As ref(Of Byte())) As event_comb
    Function append_existing(ByVal r As SEEK_RESULT,
                             ByVal value() As Byte,
                             ByVal result As ref(Of Boolean)) As event_comb
    Function delete_existing(ByVal r As SEEK_RESULT, ByVal result As ref(Of Boolean)) As event_comb
    ...
    Function sizeof_existing(ByVal r As SEEK_RESULT, ByVal result As ref(Of Int64)) As event_comb
