...
Partial Public NotInheritable Class upure_dec
    Implements ICloneable, ICloneable(Of upure_dec), IComparable, IComparable(Of upure_dec), IEquatable(Of upure_dec)
    ...
    Public Overloads Function Equals(ByVal other As upure_dec) As Boolean Implements IEquatable(Of upure_dec).Equals
        Return equal(other)
    End Function
End Class
