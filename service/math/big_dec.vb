...
Partial Public NotInheritable Class big_dec2
...
Partial Public NotInheritable Class big_dec2
    Public Function add(ByVal that As big_udec) As big_dec2
        Return add(share(that))
    End Function

    Public Function add(ByVal that As big_dec2) As big_dec2
    ...
    Public Function [sub](ByVal that As big_udec) As big_dec2
        Return [sub](share(that))
    End Function

    Public Function [sub](ByVal that As big_dec2) As big_dec2
        Dim t As big_dec2 = Nothing
        t = share(that)
    ...
    Public Function multiply(ByVal that As big_udec) As big_dec2
        Return multiply(share(that))
    End Function

    Public Function multiply(ByVal that As big_dec2) As big_dec2
    ...
    Public Function divide(ByVal that As big_udec,
                           ...
                           Optional ByRef remainder As big_dec2 = Nothing) As big_dec2
        Return divide(share(that), divide_by_zero, remainder)
    End Function

    Public Function divide(ByVal that As big_dec2,
                           ByRef divide_by_zero As Boolean,
                           Optional ByRef remainder As big_dec2 = Nothing) As big_dec2
    ...
    Public Function assert_divide(ByVal that As big_udec,
                                  Optional ByRef remainder As big_dec2 = Nothing) As big_dec2
        Return assert_divide(share(that), remainder)
    End Function

    Public Function assert_divide(ByVal that As big_dec2,
                                  Optional ByRef remainder As big_dec2 = Nothing) As big_dec2
        Dim r As Boolean = False
        divide(that, remainder, r)
        assert(Not r)
    ...
    Public Function power_2() As big_dec2
        d.power_2()
        set_positive()
        Return Me
    End Function

    Public Function power(ByVal that As big_udec) As big_dec2
        Return power(share(that))
    End Function

    Public Function power(ByVal that As big_dec2) As big_dec2
        If Not that Is Nothing Then
            If Not is_zero() Then
    ...
    Public Function extract(ByVal that As big_dec2,
                            ByRef divide_by_zero As Boolean,
                            ByRef imaginary_number As Boolean,
                            Optional ByRef remainder As big_dec2 = Nothing) As big_dec2
    ...
    Public Function assert_extract(ByVal that As big_udec,
                                   Optional ByRef remainder As big_dec2 = Nothing) As big_dec2
        Return assert_extract(share(that), remainder)
    End Function

    Public Function assert_extract(ByVal that As big_dec2,
                                   Optional ByRef remainder As big_dec2 = Nothing) As big_dec2
        Dim d As Boolean = False
        Dim i As Boolean = False
        extract(that, remainder, d, i)
...
Partial Public NotInheritable Class big_dec2
    Public Shared Widening Operator CType(ByVal this As Int32) As big_dec2
        Return New big_dec2(this)
    End Operator

    Public Shared Widening Operator CType(ByVal this As UInt32) As big_dec2
        Return New big_dec2(this)
    End Operator

    Public Shared Widening Operator CType(ByVal this As Int64) As big_dec2
        Return New big_dec2(this)
    End Operator

    Public Shared Widening Operator CType(ByVal this As UInt64) As big_dec2
        Return New big_dec2(this)
    End Operator

    Public Shared Widening Operator CType(ByVal this As big_udec) As big_dec2
        Return New big_dec2(this)
    End Operator

    Public Shared Widening Operator CType(ByVal this As Boolean) As big_dec2
        Dim r As big_dec2 = Nothing
        r = New big_dec2()
        r.replace_by(this)
        Return r
    End Operator

    Public Shared Widening Operator CType(ByVal this As big_dec2) As Boolean
        Return Not this Is Nothing AndAlso this.true()
    End Operator

    Public Shared Operator Not(ByVal this As big_dec2) As Boolean
...
Partial Public NotInheritable Class big_dec2
    ...
    Public Function less(ByVal that As big_dec2) As Boolean
        Return compare(that) < 0
    End Function
    ...
    Public Function equal(ByVal that As big_dec2) As Boolean
        Return compare(that) = 0
    End Function
    ...
    Public Function less_or_equal(ByVal that As big_dec2) As Boolean
        Return compare(that) <= 0
    End Function
    ...
    Public Function compare(ByVal that As big_dec2) As Int32
        Return compare(Me, that)
    End Function

    Public Shared Function compare(ByVal this As big_dec2, ByVal that As big_dec2) As Int32
        Dim c As Int32 = 0
    ...
    Public Shared Function compare(ByVal this As big_udec, ByVal that As big_dec2) As Int32
        Return compare(share(this), that)
    End Function

    Public Shared Function compare(ByVal this As big_dec2, ByVal that As big_udec) As Int32
...
Partial Public NotInheritable Class big_dec2
    Implements ICloneable,
               ICloneable(Of big_dec2),
               IComparable,
               IComparable(Of big_udec),
               IComparable(Of big_dec2),
               IEquatable(Of big_dec2)

    Public Function Clone() As Object Implements ICloneable.Clone
        Return CloneT()
    End Function

    Public Function CloneT() As big_dec2 Implements ICloneable(Of big_dec2).Clone
        Return New big_dec2(Me)
    End Function
    ...
    Public Function CompareTo(ByVal other As big_dec2) As Int32 Implements IComparable(Of big_dec2).CompareTo
        Return compare(other)
    End Function

    Public Function CompareTo(ByVal other As Object) As Int32 Implements IComparable.CompareTo
        Return compare(cast(Of big_dec2)().from(other, False))
    End Function

    Public Overloads Function Equals(ByVal other As big_dec2) As Boolean Implements IEquatable(Of big_dec2).Equals
        Return equal(other)
    End Function
End Class
...
Partial Public NotInheritable Class big_dec2
    Public Shared Operator +(ByVal this As big_dec2, ByVal that As big_dec2) As big_dec2
        Dim r As big_dec2 = Nothing
        r = New big_dec2(this)
        Return r.add(that)
    End Operator
    ...
    Public Shared Operator /(ByVal this As big_dec2, ByVal that As big_dec2) As pair(Of big_dec2, big_dec2)
        Dim q As big_dec2 = Nothing
        Dim r As big_dec2 = Nothing
        q = New big_dec2(this)
        q.divide(that, r)
    ...
    Public Shared Operator Mod(ByVal this As big_dec2, ByVal that As big_dec2) As big_dec2
        Dim q As big_dec2 = Nothing
        Dim r As big_dec2 = Nothing
        q = New big_dec2(this)
        q.divide(that, r)
    ...
    Public Shared Operator >(ByVal this As big_dec2, ByVal that As big_dec2) As Boolean
    ...
    Public Shared Operator >>(ByVal this As big_dec2, ByVal that As Int32) As big_dec2
        Dim r As big_dec2 = Nothing
        r = New big_dec2(this)
...
Partial Public NotInheritable Class big_dec2
    Public Overrides Function Equals(ByVal obj As Object) As Boolean
        Return equal(cast(Of big_dec2)().from(obj, False))
    End Function
...
Partial Public NotInheritable Class big_dec2
    Public Shared Function zero() As big_dec2
        Return New big_dec2()
    End Function

    Public Shared Function _0() As big_dec2
        Return zero()
    End Function

    Public Shared Function one() As big_dec2
        Return New big_dec2(uint32_1)
    End Function

    Public Shared Function _1() As big_dec2
        Return one()
    End Function

    Public Shared Function negative_one() As big_dec2
        Return New big_dec2(-1)
    End Function

    Public Shared Function n1() As big_dec2
        Return negative_one()
    End Function
End Class
...
Partial Public NotInheritable Class big_dec2
    ...
    Private Shared Function share(ByVal i As big_udec) As big_dec2
        If i Is Nothing Then
            Return Nothing
        Else
            Return New big_dec2(i, True)
        End If
    End Function

    Private Shared Function share(ByVal i As big_dec2) As big_dec2
        If i Is Nothing Then
            Return Nothing
        Else
            Return New big_dec2(i.d, i.s)
        End If
    End Function
    ...
    Private Sub divide(ByVal that As big_dec2, ByRef remainder As big_dec2, ByRef divide_by_zero As Boolean)
    ...
    Private Sub extract(ByVal that As big_dec2,
                        ByRef remainder As big_dec2,
                        ByRef divide_by_zero As Boolean,
                        ByRef imaginary_number As Boolean)
        If that Is Nothing Then
            Return
...
Partial Public NotInheritable Class big_dec2
    ...
    Public Shared Function random(Optional ByVal length As UInt32 = 0) As big_dec2
        Dim r As big_dec2 = Nothing
...
Partial Public NotInheritable Class big_dec2
    Public Function left_shift(ByVal size As Int32) As big_dec2
        d.left_shift(size)
        Return Me
    End Function

    Public Function left_shift(ByVal size As UInt64) As big_dec2
        d.left_shift(size)
        Return Me
    End Function

    Public Function left_shift(ByVal size As big_dec2, ByRef overflow As Boolean) As big_dec2
    ...
    Public Function left_shift(ByVal size As big_udec, ByRef overflow As Boolean) As big_dec2
        If Not size Is Nothing Then
            Dim u As UInt64 = 0
            u = size.as_uint64(overflow)
            If Not overflow Then
    ...
    Public Function left_shift(ByVal size As big_dec2) As big_dec2
    ...
    Public Function left_shift(ByVal size As big_udec) As big_dec2
        Dim o As Boolean = False
        assert(object_compare(left_shift(size, o), Me) = 0)
        If o Then
            Throw overflow()
    ...
    Public Function assert_left_shift(ByVal size As big_dec2) As big_dec2
        Dim o As Boolean = False
        assert(object_compare(left_shift(size, o), Me) = 0)
        assert(Not o)
        Return Me
    ...
    Public Function assert_left_shift(ByVal size As big_udec) As big_dec2
        Dim o As Boolean = False
        assert(object_compare(left_shift(size, o), Me) = 0)
        assert(Not o)
        Return Me
    ...
    Public Function right_shift(ByVal size As Int32) As big_dec2
        d.right_shift(size)
        Return Me
    End Function

    Public Function right_shift(ByVal size As UInt64) As big_dec2
        d.right_shift(size)
        Return Me
    End Function

    Public Function right_shift(ByVal size As big_dec2, ByRef overflow As Boolean) As big_dec2
        If Not size Is Nothing Then
            Dim u As UInt64 = 0
            u = size.as_uint64(overflow)
            If Not overflow Then
    ...
    Public Function right_shift(ByVal size As big_udec, ByRef overflow As Boolean) As big_dec2
        If Not size Is Nothing Then
            Dim u As UInt64 = 0
            u = size.as_uint64(overflow)
            If Not overflow Then
    ...
    Public Function right_shift(ByVal size As big_dec2) As big_dec2
        Dim o As Boolean = False
    ...
    Public Function right_shift(ByVal size As big_udec) As big_dec2
        Dim o As Boolean = False
        assert(object_compare(right_shift(size, o), Me) = 0)
        If o Then
            Throw overflow()
    ...
    Public Function assert_right_shift(ByVal size As big_dec2) As big_dec2
        Dim o As Boolean = False
        assert(object_compare(right_shift(size, o), Me) = 0)
        assert(Not o)
        Return Me
    ...
    Public Function assert_right_shift(ByVal size As big_udec) As big_dec2
        Dim o As Boolean = False
        assert(object_compare(right_shift(size, o), Me) = 0)
        assert(Not o)
        Return Me
...
Partial Public NotInheritable Class big_dec2
    ...
    Public Sub New(ByVal i As big_dec2)
        Me.New()
        assert(replace_by(i))
    End Sub
    ...
    Public Shared Function move(ByVal i As big_dec2) As big_dec2
        ...
        s = i.signal()
        Dim r As big_dec2 = Nothing
        r = New big_dec2(big_udec.move(i.d), s)
        i.confirm_signal()
        Return r
    End Function

    Public Shared Function swap(ByVal this As big_dec2, ByVal that As big_dec2) As Boolean
    ...
    Public Function replace_by(ByVal i As big_dec2) As Boolean
        If i Is Nothing Then
            Return False
        End If
