...
Namespace constants
    Public NotInheritable Class multi_filter
        Public Shared ReadOnly separators() As Char = {character.comma, character.sheffer}

        Private Sub New()
        End Sub
    End Class

    Public NotInheritable Class compare_filter
    ...
    Public NotInheritable Class interval_filter
        Public Shared ReadOnly separators() As Char = {character.minus_sign, character.comma}
    ...
    Public NotInheritable Class static_filter
