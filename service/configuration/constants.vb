...
Namespace constants
    ...
    Namespace filter_selector
        Friend Module _filter_selector
            ...
            Public Const string_care_case As String = "str-case"
            Public Const string_pattern_care_case As String = "str-pat-case"
            Public Const string_serial_care_case As String = "str-ser-case"
            Public Const string_patterns_care_case As String = "str-pats-case"
            Public Const string_compare_care_case As String = "str-com-case"
            Public Const string_interval_care_case As String = "str-int-case"
            Public Const string_pattern_care_case_cache As String = "str-pat-case-cache"
            Public Const string_patterns_care_case_cache As String = "str-pats-case-cache"
            Public Const string_prefix_care_case As String = "str-pre-case"
            Public Const string_prefixes_care_case As String = "str-pres-case"
