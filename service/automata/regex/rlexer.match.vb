        ...
        Else
            ...
            While j < [end]
                ...
                For k As UInt32 = 0 To rs.size() - uint32_1
                    If Not rs(k) Is Nothing Then
                        ...
                        Else
                            ...
                            End If
                        End If
                        If type_choice = match_choice.first_defined AndAlso
                           Not matches.empty() Then
                            Exit For
                        End If
                    End If
                Next
                If matches.empty() Then
                    Return False
                ElseIf matches.back().second = [end] Then
                    o.emplace_back(New typed_word(i,
                                                  j,
                                                  matches.back().second,
                                                  matches.back().first))
                    Return True
                ElseIf matches.size() = uint32_1 OrElse type_choice = match_choice.first_defined Then
                    o.emplace_back(New typed_word(i, j, matches(0).second, matches(0).first))
                    j = matches(0).second
                Else
                    If type_choice = match_choice.greedy Then
                    ...
                    ElseIf type_choice = match_choice.multipath Then
