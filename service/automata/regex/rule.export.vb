...
Partial Class rlexer
    Partial Public Class rule
        ...
        Public Class exporter
            ...
            Private ReadOnly str_type As map(Of String, UInt32)
            Private ReadOnly type_str As map(Of UInt32, String)
            ...
            Public Shared Function create(ByVal i As rule, ByRef o As exporter) As Boolean
                ...
                Else
                    ...
                    Dim str_type As map(Of String, UInt32) = Nothing
                    Dim type_str As map(Of UInt32, String) = Nothing
                    str_type = New map(Of String, UInt32)()
                    type_str = New map(Of UInt32, String)()
                    macros = New macros()
            ...
            Public Function str_type_mapping() As map(Of String, UInt32)
                Return copy(str_type)
            End Function

            Public Function type_str_mapping() As map(Of UInt32, String)
                Return copy(type_str)
            End Function

            Public Sub types_mapping(ByRef str_type As map(Of String, UInt32),
                                     ByRef type_str As map(Of UInt32, String))
