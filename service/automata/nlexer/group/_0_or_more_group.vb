...
Partial Public NotInheritable Class nlexer
    Public NotInheritable Class _0_or_more_group
        Implements matcher
        ...
        Public Function match(ByVal i As String, ByVal pos As UInt32) As [optional](Of UInt32) Implements matcher.match
            Dim r As [optional](Of UInt32) = [optional].of(pos)
            While True
                Dim n As [optional](Of UInt32) = g.match(i, +r)
                If n Then
                    r = n
                Else
                    Exit While
        ...
        Public Shared Sub register()
            groups.register(characters._0_or_more_suffix,
                            Function(ByVal i As matcher) As matcher
                                Return New _0_or_more_group(i)
                            End Function)
        End Sub
    End Class
End Class
