...
' Refer to osi.service.selector.sharedtransmitter(Of PORT_T, ADDRESS_T, COMPONENT_T, DATA_T, PARAMETER_T)
Partial Public Class shared_device(Of PORT_T, ADDRESS_T, COMPONENT_T, DATA_T, PARAMETER_T)
    Private ReadOnly sc As sharedtransmitter(Of PORT_T, ADDRESS_T, idevice(Of COMPONENT_T), DATA_T, PARAMETER_T)
