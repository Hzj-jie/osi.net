...
Namespace logic
    Partial Public NotInheritable Class importer
        ...
        Private Function parse_move_heap_out_28(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
            assert(v.size() > p)
            If Not v(p).Equals("move_heap_out") Then
                Return False
            End If
            Dim start As UInt32 = p
            p += uint32_1
        ...
        Private Function parse_move_heap_in_29(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
            assert(v.size() > p)
            If Not v(p).Equals("move_heap_in") Then
                Return False
            End If
            Dim start As UInt32 = p
            p += uint32_1
        ...
        Private Function parse_define_30(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_define_heap_31(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_do_until_32(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_do_while_33(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_interrupt_34(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_move_35(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_return_36(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_append_38(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_sizeof_40(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_empty_41(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_while_then_42(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_stop_43(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_add_44(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_subtract_45(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_multiply_46(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_divide_47(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_extract_48(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_power_49(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_less_50(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_more_51(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_equal_52(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_less_or_equal_53(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_more_or_equal_54(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_left_shift_55(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_right_shift_56(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse(ByVal v As vector(Of String),
            ...
            Using code_block
                Dim pos As UInt32 = p
                If parse_move_heap_out_28(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_move_heap_in_29(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_define_30(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_define_heap_31(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_do_until_32(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_do_while_33(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_interrupt_34(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = p
                If parse_return_36(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = p
                If parse_append_38(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = p
                If parse_sizeof_40(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_empty_41(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_while_then_42(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_add_44(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_subtract_45(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_multiply_46(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_divide_47(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_extract_48(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_power_49(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_less_50(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_more_51(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_equal_52(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_less_or_equal_53(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_more_or_equal_54(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_left_shift_55(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_right_shift_56(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
