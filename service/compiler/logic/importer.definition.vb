...
Namespace logic
    Partial Public NotInheritable Class importer
        ...
        Private Function parse_do_until_27(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_do_while_28(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_interrupt_29(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_move_30(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_append_33(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_sizeof_35(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_empty_36(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_while_then_37(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_stop_38(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_add_39(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_subtract_40(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_multiply_41(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_divide_42(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_extract_43(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_power_44(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_less_45(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_more_46(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_equal_47(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_less_or_equal_48(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_more_or_equal_49(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_left_shift_50(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_right_shift_51(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As exportable) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse(ByVal v As vector(Of String),
            ...
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_do_until_27(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_do_while_28(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_interrupt_29(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_append_33(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_sizeof_35(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_empty_36(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_while_then_37(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_add_39(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_subtract_40(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_multiply_41(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_divide_42(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_extract_43(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_power_44(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_less_45(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_more_46(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_equal_47(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_less_or_equal_48(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_float_more_or_equal_49(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_left_shift_50(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = 0
                pos = p
                If parse_right_shift_51(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
