...
Namespace logic
    Partial Public NotInheritable Class importer
        ...
        Private Function parse_redefine_32(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_define_heap_33(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_redefine_heap_34(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
            assert(v.size() > p)
            If Not v(p).Equals("redefine_heap") Then
                Return False
            End If
            Dim start As UInt32 = p
            p += uint32_1
        ...
        Private Function parse_unmanage_heap_35(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_dealloc_heap_36(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_do_until_37(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_do_while_38(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_interrupt_39(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_move_40(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_return_42(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_append_43(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_sizeof_45(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_empty_46(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_while_then_47(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_stop_48(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_add_49(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_subtract_50(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_multiply_51(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_divide_52(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_extract_53(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_power_54(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_less_55(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_more_56(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_equal_57(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_less_or_equal_58(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_float_more_or_equal_59(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_left_shift_60(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse_right_shift_61(
                ByVal v As vector(Of String),
                ByRef p As UInt32,
                ByRef o As instruction_gen) As Boolean
            assert(Not v Is Nothing)
        ...
        Private Function parse(ByVal v As vector(Of String),
            ...
            Using code_block
                Dim pos As UInt32 = p
                If parse_redefine_32(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_define_heap_33(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_redefine_heap_34(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_unmanage_heap_35(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_dealloc_heap_36(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_do_until_37(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_do_while_38(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_interrupt_39(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = p
                If parse_return_42(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_append_43(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = p
                If parse_sizeof_45(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_empty_46(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_while_then_47(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            ...
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_add_49(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_subtract_50(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_multiply_51(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_divide_52(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_extract_53(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_power_54(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_less_55(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_more_56(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_equal_57(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_less_or_equal_58(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_float_more_or_equal_59(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_left_shift_60(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
            Using code_block
                Dim pos As UInt32 = p
                If parse_right_shift_61(v, pos, o) Then
                    p = pos
                    Return True
                End If
            End Using
