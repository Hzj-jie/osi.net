    ...
    Public NotInheritable Class reinterpret_cast
        ...
        Public Function build(ByVal n As typed_node,
            ...
            If n.child_count() = 6 Then
                Return builders.of_redefine(name, type).to(o) AndAlso
                       scope.current().variables().redefine(type, name)
            End If
            Return builders.of_redefine_heap(name, type).to(o) AndAlso
                   scope.current().variables().redefine_heap(type, name)
        End Function
    End Class
End Class
