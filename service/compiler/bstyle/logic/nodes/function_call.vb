        ...
        Private Function build(ByVal n As typed_node,
            ...
            Dim bc As Func(Of vector(Of String), Boolean) =
                Function(ByVal parameters As vector(Of String)) As Boolean
                    If scope.current().variables().try_resolve(n.child(0).input_without_spacing(), Nothing, Nothing) Then
                        Return build_caller_ref(n.child(0).input_without_spacing(), parameters)
                    End If

                    Dim name As String = Nothing
                    If Not logic_name.of_function_call(n.child(0).input_without_spacing(), parameters, name) Then
                        Return False
                    End If
