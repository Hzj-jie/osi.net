...
Public NotInheritable Class ranking_test
    ...
    Private Shared Sub descent_case()
        assertion.near_match(p.descent.ranking(streams.range(0, 100).collect(Of vector(Of Int32))(), 80), 0.2, 0.00001)
        assertion.near_match(p.descent.ranking(streams.range(0, 100).collect(Of vector(Of Int32))(), 99), 0.01, 0.00001)
        assertion.near_match(p.descent.ranking(streams.range(0, 100).collect(Of vector(Of Int32))(), 0), 1, 0.00001)
        assertion.near_match(p.descent.ranking(streams.range(0, 100).collect(Of vector(Of Int32))(), 1), 0.99, 0.00001)
    End Sub

    <test>
    Private Shared Sub large_range_case()
        assertion.near_match(p.ascent.ranking(streams.range(0, 10000).collect(Of vector(Of Int32))(),
                                              9000),
                             0.91,
                             0.05)
        assertion.near_match(p.ascent.ranking(streams.range(0, 10000).collect(Of vector(Of Int32))(),
    ...
    Private Shared Sub large_range_case2()
        assertion.near_match(p.ascent.ranking(streams.range(0, 10000000).collect(Of vector(Of Int32))(),
                                              9123456),
                             0.92,
                             0.05)
        assertion.near_match(p.ascent.ranking(streams.range(0, 10000000).collect(Of vector(Of Int32))(),
