...
Public Class auto_device_exporter_idevice_test
    ...
    Private Shared Function no_concurrent_generation_case() As Boolean
        ...
        assert_true(timeslice_sleep_wait_until(Function() c = count, seconds_to_milliseconds(1)))
        ...
        d.require(count)
        assert_true(timeslice_sleep_wait_until(Function() c = (count << 1), seconds_to_milliseconds(1)))
        ...
        assert_true(timeslice_sleep_wait_until(Function() stopped, seconds_to_milliseconds(1)))
        d.require(count)
        assert_false(timeslice_sleep_wait_when(Function() c = (count << 1), seconds_to_milliseconds(1)))
        assert_equal(c, count << 1)
        assert_equal(d.exported(), count << 1)
        assert_equal(mock_dev(Of auto_device_exporter_idevice_test).constructed(), c)
        Return True
