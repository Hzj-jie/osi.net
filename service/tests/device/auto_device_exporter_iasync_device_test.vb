...
Public Class auto_device_exporter_iasync_device_test
    Inherits [case]

    Private Shared Function basic_case() As Boolean
        Dim e As auto_device_exporter(Of mock_dev(Of auto_device_exporter_async_adapter_test)) = auto_device_exporter.[New](New mock_device_async_creator(Of auto_device_exporter_async_adapter_test)())
