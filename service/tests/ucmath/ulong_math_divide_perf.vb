...
'with ulong_math_divide_perf.vbp ----------
'so change ulong_math_divide_perf.vbp instead of this file
...
Public NotInheritable Class ulong_math_divide_perf
    ...
    Public Sub New()
        MyBase.New(New ulong_math_divide_case())
    End Sub

    Private Class ulong_math_divide_case
        Inherits [case]
...
'finish ulong_math_divide_perf.vbp --------
