...
Public NotInheritable Class big_udec_str_test
    ...
    Private Shared Sub e()
        Dim v As New big_udec(System.Math.E)
    ...
    Private Shared Sub pi()
        Dim v As New big_udec(System.Math.PI)
    ...
    Private Shared Sub _0_999999999()
        Dim u As New big_udec(0.999999999)
    ...
    Private Shared Sub _0_00000000001()
        Dim u As New big_udec(0.00000000001)
    ...
    Private Shared Sub e_pure_part()
        Dim u As New big_udec(System.Math.E - 2)
    ...
    Private Shared Sub pi_pure_part()
        Dim u As New big_udec(System.Math.PI - 3)
