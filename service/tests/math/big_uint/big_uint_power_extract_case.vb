...
Friend Class big_uint_power_extract_case
    Inherits [case]

    Public Shared Function create_case(Optional ByVal round_scale As Int64 = 1) As [case]
        Return repeat(New big_uint_power_extract_case(), round_scale * 128 * If(isdebugbuild(), 1, 4))
    End Function
    ...
    Private Shared Function power_extract_case(ByVal i As UInt64, ByVal j As UInt64) As Boolean
        ...
        assert_true(b.equal(New big_uint(i)))
        ...
        assert_not_nothing(r)
        assert_true(b.equal(New big_uint(i)))
        assert_true(r.equal(New big_uint(t)))
        Return True
    End Function
