...
Namespace rlexer
    Public Class any_matching_group_test
        ...
        Private Shared Function case1() As Boolean
            Dim g As New any_matching_group(New string_matching_group("a", "b", "c"))
        ...
        Private Shared Function case2() As Boolean
            Dim g As New any_matching_group(New string_matching_group("", "a", "b"))
            Dim v As vector(Of UInt32) = g.match("abc")
            If assertion.is_true(Not v.null_or_empty()) Then
        ...
        Private Shared Function case4() As Boolean
            Dim g As New any_matching_group(New any_character_matching_group())
            Dim v As vector(Of UInt32) = g.match("abc")
