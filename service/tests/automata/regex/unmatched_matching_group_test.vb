...
Namespace rlexer
    Public Class unmatched_matching_group_test
        ...
        Private Shared Function case1() As Boolean
            Dim g As New unmatched_matching_group(New any_character_matching_group())
        ...
        Private Shared Function case2() As Boolean
            Dim g As New unmatched_matching_group(New string_matching_group("abc"))
            Dim v As vector(Of UInt32) = g.match("abcd")
            assertion.is_true(v.null_or_empty())
            v = g.match("bcd")
