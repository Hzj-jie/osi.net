...
Partial Public Class constructor_test
    ...
    Private Shared Sub prefer_type_constructor()
        ...
        assert_true(c.constructor.register(type,
                                           ...
                                           End Function))
        assert_true(c.constructor.register(Function(ByVal v As var) As test_prefer_type_constructor_class
                                               Return New test_prefer_type_constructor_class(2)
                                           End Function))
        Dim r As test_prefer_type_constructor_class = Nothing
        assert_true(c.constructor.sync_resolve(New var(strcat("--type=", type)), r))
        assert_not_nothing(r)
        assert_equal(r.i, 1)
        assert_true(c.constructor(Of test_prefer_type_constructor_class).erase(type))
        assert_true(c.constructor(Of test_prefer_type_constructor_class).erase())
    End Sub
    ...
    Private Shared Sub ignore_empty_type_or_allocator()
        assert_false(c.constructor(Of test_class).register(Nothing))
        assert_false(c.constructor(Of test_class).register(Nothing,
                                                           Function(ByVal v As var,
                                                                  ByVal o As pointer(Of test_class)) As event_comb
                                                               Return event_comb.failed()
                                                           End Function))
        assert_false(c.constructor(Of test_class).register(Nothing, Nothing))
    End Sub
    ...
    Private Shared Sub return_false_when_constructor_failed()
        ...
        assert_false(c.constructor.sync_resolve(New var(strcat("--type=", type)), r))
        assert_nothing(r)
    ...
    Private Shared Sub return_false_when_constructor_failed2()
        assert_true(c.constructor.register(Function(ByVal v As var,
        ...
        assert_false(c.constructor.sync_resolve(New var(), r))
        assert_nothing(r)
        assert_true(c.constructor(Of test_return_false_when_constructor_failed2_class).erase())
    End Sub
    ...
    Private Shared Sub return_false_if_no_constructor()
        assert_true(c.constructor(Of test_return_false_if_no_constructor_class).empty())
    ...
    Private Shared Sub return_value_is_wrapped()
        ...
        assert_true(c.constructor.sync_resolve(New var(strcat("--type=", type, " --wrapper=", type)), r))
        assert_not_nothing(r)
