...
'case1 case2 bool_and_bool str_unescape _1_to_100 self_add biguint negative_int another_1_to_100 loaded_method ufloat_std_out ufloat_operators while_1_to_100 while_0_to_1 pi_integral_0_1 calculate_pi_bbp
...
Friend Module _b2style_test_data
    ...
    Sub New()
        ...
        calculate_pi_bbp = Convert.FromBase64String(strcat_hint(CUInt(120), _
        "77u/DQp2b2lkIG1haW4oKSB7DQogIHVmbG9hdCBzID0gMC4wOw0KICBmb3IgKGludCBpID0gMDsgaSA8IDEwMDA7IGkrKykgew0KICAgIA0KICB9DQp9DQo="))
    End Sub
End Module
