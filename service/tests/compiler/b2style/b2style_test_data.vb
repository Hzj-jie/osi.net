...
' _b2style_test_data "[order_of_operators]" "order_of_operators.txt" "[heap_function_ref]" "heap_function_ref.txt" "[self_add]" "self_add.txt" "[shift]" "shift.txt" "[heap_declaration]" "heap_declaration.txt" "[for_loop]" "for_loop.txt" "[struct_function_ref]" "struct_function_ref.txt" "[biguint]" "biguint.txt" "[typedef]" "typedef.txt" "[comments]" "comments.txt" "[bool_and_bool]" "bool_and_bool.txt" "[class_in_namespace]" "class_in_namespace.txt" "[include2]" "include2.txt" "[nested_heap_access]" "nested_heap_access.txt" "[heap]" "heap.txt" "[include]" "include.txt" "[while_1_to_100]" "while_1_to_100.txt" "[legacy_biguint_to_str]" "legacy_biguint_to_str.txt" "[nested_class]" "nested_class.txt" "[function_ref]" "function_ref.txt" "[struct_in_namespace]" "struct_in_namespace.txt" "[loaded_method]" "loaded_method.txt" "[multiline_string]" "multiline_string.txt" "[case2]" "case2.txt" "[function_with_global_namespace]" "function_with_global_namespace.txt" "[namespaces]" "namespaces.txt" "[pi_integral_0_1]" "pi_integral_0_1.txt" "[ufloat_operators]" "ufloat_operators.txt" "[calculate_pi_bbp]" "calculate_pi_bbp.txt" "[i__]" "i++.txt" "[class_on_heap]" "class_on_heap.txt" "[heap_ptr_to_int64]" "heap_ptr_to_int64.txt" "[negative_int]" "negative_int.txt" "[_1_to_100]" "_1_to_100.txt" "[class_function_with_namespace]" "class_function_with_namespace.txt" "[another_1_to_100]" "another_1_to_100.txt" "[str_unescape]" "str_unescape.txt" "[case1]" "case1.txt" "[nested_paragraph]" "nested_paragraph.txt" "[i__2]" "i++2.txt" "[while_0_to_1]" "while_0_to_1.txt" "[ufloat_std_out]" "ufloat_std_out.txt" "[class]" "class.txt" "[ifndef]" "ifndef.txt" "[__i__]" "++i++.txt" "[__i]" "++i.txt" "[errors_missing_ending_quota]" "errors\missing-ending-quota.txt" "[errors_function_name_ends_with_dot]" "errors\function-name-ends-with-dot.txt" "[errors_value_clause_struct_type_mismatch2]" "errors\value-clause-struct-type-mismatch2.txt" "[errors_function_return_struct_type_mismatch]" "errors\function-return-struct-type-mismatch.txt" "[errors_three_pluses]" "errors\three-pluses.txt" "[errors_dollar_in_number]" "errors\dollar-in-number.txt" "[errors_value_clause_struct_type_mismatch]" "errors\value-clause-struct-type-mismatch.txt" "[errors_include_needs_wraps]" "errors\include-needs-wraps.txt" "[errors_cycle_typedef]" "errors\cycle-typedef.txt"
...
'[order_of_operators] [heap_function_ref] [self_add] [shift] [heap_declaration] [for_loop] [struct_function_ref] [biguint] [typedef] [comments] [bool_and_bool] [class_in_namespace] [include2] [nested_heap_access] [heap] [include] [while_1_to_100] [legacy_biguint_to_str] [nested_class] [function_ref] [struct_in_namespace] [loaded_method] [multiline_string] [case2] [function_with_global_namespace] [namespaces] [pi_integral_0_1] [ufloat_operators] [calculate_pi_bbp] [i__] [class_on_heap] [heap_ptr_to_int64] [negative_int] [_1_to_100] [class_function_with_namespace] [another_1_to_100] [str_unescape] [case1] [nested_paragraph] [i__2] [while_0_to_1] [ufloat_std_out] [class] [ifndef] [__i__] [__i] [errors_missing_ending_quota] [errors_function_name_ends_with_dot] [errors_value_clause_struct_type_mismatch2] [errors_function_return_struct_type_mismatch] [errors_three_pluses] [errors_dollar_in_number] [errors_value_clause_struct_type_mismatch] [errors_include_needs_wraps] [errors_cycle_typedef]
