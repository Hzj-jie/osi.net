...
' _b2style_test_data "[__i__]" "++i++.txt" "[__i]" "++i.txt" "[another_1_to_100]" "another_1_to_100.txt" "[biguint]" "biguint.txt" "[bool_and_bool]" "bool_and_bool.txt" "[calculate_pi_bbp]" "calculate_pi_bbp.txt" "[case1]" "case1.txt" "[case2]" "case2.txt" "[class]" "class.txt" "[class_on_heap]" "class_on_heap.txt" "[comments]" "comments.txt" "[for_loop]" "for_loop.txt" "[function_ref]" "function_ref.txt" "[heap]" "heap.txt" "[heap_declaration]" "heap_declaration.txt" "[heap_function_ref]" "heap_function_ref.txt" "[i__]" "i++.txt" "[i__2]" "i++2.txt" "[ifndef]" "ifndef.txt" "[include]" "include.txt" "[include2]" "include2.txt" "[legacy_biguint_to_str]" "legacy_biguint_to_str.txt" "[loaded_method]" "loaded_method.txt" "[multiline_string]" "multiline_string.txt" "[namespaces]" "namespaces.txt" "[negative_int]" "negative_int.txt" "[nested_class]" "nested_class.txt" "[nested_paragraph]" "nested_paragraph.txt" "[order_of_operators]" "order_of_operators.txt" "[pi_integral_0_1]" "pi_integral_0_1.txt" "[self_add]" "self_add.txt" "[shift]" "shift.txt" "[struct_function_ref]" "struct_function_ref.txt" "[struct_in_namespace]" "struct_in_namespace.txt" "[str_unescape]" "str_unescape.txt" "[typedef]" "typedef.txt" "[ufloat_operators]" "ufloat_operators.txt" "[ufloat_std_out]" "ufloat_std_out.txt" "[while_0_to_1]" "while_0_to_1.txt" "[while_1_to_100]" "while_1_to_100.txt" "[_1_to_100]" "_1_to_100.txt" "[errors_cycle_typedef]" "errors\cycle-typedef.txt" "[errors_dollar_in_number]" "errors\dollar-in-number.txt" "[errors_function_name_ends_with_dot]" "errors\function-name-ends-with-dot.txt" "[errors_function_return_struct_type_mismatch]" "errors\function-return-struct-type-mismatch.txt" "[errors_include_needs_wraps]" "errors\include-needs-wraps.txt" "[errors_three_pluses]" "errors\three-pluses.txt" "[errors_value_clause_struct_type_mismatch]" "errors\value-clause-struct-type-mismatch.txt" "[errors_value_clause_struct_type_mismatch2]" "errors\value-clause-struct-type-mismatch2.txt"
...
Friend Module _b2style_test_data
    ...
    Sub New()
        ...
        [i__] = Convert.FromBase64String(strcat_hint(CUInt(448), _
        ""))
