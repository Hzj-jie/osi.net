...
'[call_struct_on_heap] [case1] [case2] [delegate] [empty_struct_overloads] [errors_dot_is_disallowed_as_the_end_of_name] [for_loop] [func_name_with_dot] [function_struct] [global_variable] [nested_struct] [overload_function] [return_struct] [single_level_struct] [statement]
