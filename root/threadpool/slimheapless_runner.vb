...
'with slimheapless_runner.vbp ----------
'so change slimheapless_runner.vbp instead of this file
...
Public NotInheritable Class slimheapless_runner
    ...
    Public Sub New()
        Me.New(New waitable_slimheapless(Of Action)())
    End Sub

    Public Sub New(ByVal q As waitable_slimheapless(Of Action))
        ...
        Me.t = New Thread(Sub()
                              ...
                              End Try
                          End Sub)
        Me.t.Name() = "slimheapless_runner_thread"
        t.Start()
        assert(Not stopping())
    End Sub
    ...
    Public Shared Operator +(ByVal this As slimheapless_runner, ByVal that As Action) As slimheapless_runner
...
'finish slimheapless_runner.vbp --------
