...
Public Class endian_test
    ...
    Public Overrides Function run() As Boolean
        For i As Int32 = 0 To array_size(int16_cases) - 1
        ...
        Next
        For i As Int32 = 0 To array_size(uint16_cases) - 1
        ...
        Next
        For i As Int32 = 0 To array_size(int64_cases) - 1
        ...
        Next
        For i As Int32 = 0 To array_size(uint64_cases) - 1
