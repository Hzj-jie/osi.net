...
Public Class event_comb_while_test
    ...
    Private Shared Function case1_true() As Boolean
        ...
        Dim i As Int32 = 0
        Dim j As Int32 = 0
        assert_true(async_sync(event_comb.while(Function(last_ec As event_comb,
                                                         error_break As pointer(Of Boolean)) As event_comb
                                                    Return sync_async(Function() As Boolean
                                                                          If i > 0 Then
                                                                              If assert_not_nothing(last_ec) Then
                                                                                  assert_true(last_ec.end_result())
                                                                              End If
                                                                          Else
                                                                              assert_nothing(last_ec)
                                                                          End If
                                                                          assert_not_nothing(error_break)
                                                                          assert_false(+error_break)
                                                                          i += 1
                                                                          Return i < round
                                                                      End Function)
                                                End Function,
    ...
    Private Shared Function case1_false() As Boolean
        ...
        Dim i As Int32 = 0
        Dim j As Int32 = 0
        assert_false(async_sync(event_comb.while(Function(last_ec As event_comb,
                                                          error_break As pointer(Of Boolean)) As event_comb
                                                     Return sync_async(Function() As Boolean
                                                                           If i > 0 Then
                                                                               If assert_not_nothing(last_ec) Then
    ...
    Private Shared Function case2_true() As Boolean
        ...
        Dim i As Int32 = 0
        Dim j As Int32 = 0
        assert_true(async_sync(event_comb.while(Function() As event_comb
                                                    Return sync_async(Sub()
                                                                          j += 1
                                                                      End Sub)
                                                End Function,
    ...
    Private Shared Function case2_false() As Boolean
        ...
        Dim i As Int32 = 0
        Dim j As Int32 = 0
        assert_false(async_sync(event_comb.while(Function() As event_comb
                                                     Return sync_async(Sub()
                                                                           j += 1
                                                                       End Sub)
                                                 End Function,
