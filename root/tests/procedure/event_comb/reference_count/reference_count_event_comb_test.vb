...
Public Class reference_count_event_comb_test
    Inherits [case]

    Private Class reference_count_event_comb_case
        Inherits [case]

        Public ReadOnly rcec As reference_count_event_comb
        ...
        Protected Overridable Function ctor() As reference_count_event_comb
            Return reference_count_event_comb.ctor(
                       Sub()
                           c1.increment()
                           c2.increment()
                       End Sub)
    ...
    Private Class reference_count_event_comb_case2
        Inherits reference_count_event_comb_case
        ...
        Protected Overrides Function ctor() As reference_count_event_comb
            Return reference_count_event_comb.ctor(
    ...
    Private Overloads Function run(ByVal rc As reference_count_event_comb_case, ByVal c As [case]) As Boolean
    ...
    Private Function run_case() As Boolean
        Dim rc As reference_count_event_comb_case = Nothing
        rc = New reference_count_event_comb_case()
    ...
    Private Function run_case2() As Boolean
        ...
        Dim rc As reference_count_event_comb_case2 = Nothing
        rc = New reference_count_event_comb_case2()
        Dim c As [case] = Nothing
