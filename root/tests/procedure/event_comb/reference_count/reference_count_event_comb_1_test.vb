...
'with reference_count_event_comb_1_test.vbp ----------
'so change reference_count_event_comb_1_test.vbp instead of this file
...
Public Class reference_count_event_comb_1_test
    Inherits [case]

    Private Class reference_count_event_comb_1_case
        Inherits [case]
        ...
        Protected Overridable Function ctor() As reference_count_event_comb_1
            Return reference_count_event_comb_1.ctor(
                       Sub()
                           c1.increment()
                           c2.increment()
                       End Sub)
    ...
    Private Class reference_count_event_comb_1_case2
        Inherits reference_count_event_comb_1_case
    ...
    Private Overloads Function run(ByVal rc As reference_count_event_comb_1_case, ByVal c As [case]) As Boolean
    ...
    Private Function run_case() As Boolean
        Dim rc As reference_count_event_comb_1_case = Nothing
        rc = New reference_count_event_comb_1_case()
    ...
    Private Function run_case2() As Boolean
        ...
        Dim rc As reference_count_event_comb_1_case2 = Nothing
        rc = New reference_count_event_comb_1_case2()
        Dim c As [case] = Nothing
        ...
        assert_equal(+(rc.c1), last)
        assert_equal(+(rc.c2.p), last)
        If reference_count_event_comb_1.start_after_trigger() Then
...
'finish reference_count_event_comb_1_test.vbp --------
