...
Public NotInheritable Class promise_test
    Inherits [case]
    ...
    Private Shared Function basic_case() As Boolean
        ...
        Dim p As promise = promise.of(Sub(ByVal resolve As Action(Of Object))
    ...
    Private Shared Function chain_more_case() As Boolean
        ...
        Dim p As promise = promise.of(Sub(ByVal resolve As Action(Of Object))
                                          assert(Not stopwatch.push(10,
                                                      ...
                                                      End Sub) Is Nothing)
                                      End Sub).
                                   then(Function(v As Object) As Object
                                            assertion.is_true(v.GetType().[is](Of Int32)())
    ...
    Private Shared Function share_resolve_case() As Boolean
        ...
        Dim mre As New ManualResetEvent(False)
        Dim start_ms As Int64 = nowadays.milliseconds()
        Dim p As promise = promise.of(Function() As Object
                                          Return promise.resolve(New promise(
                                                  Sub(ByVal resolve As Action(Of Object))
