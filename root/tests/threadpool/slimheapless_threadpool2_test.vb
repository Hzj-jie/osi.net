...
'with slimheapless_threadpool2_test.vbp ----------
'so change slimheapless_threadpool2_test.vbp instead of this file
...
Public Class slimheapless_threadpool2_manual_test
    Inherits commandline_specified_case_wrapper

    Public Sub New()
        MyBase.New(rinne(New slimheapless_threadpool2_test(1024 * 1024), 1024 * 32))
    End Sub
End Class

Public Class slimheapless_threadpool2_test
    Inherits [case]

    Private ReadOnly round As Int64
    Private ReadOnly inserted As atomic_int64
    Private ReadOnly executed As atomic_int64
    Private t As slimheapless_threadpool2
    ...
    Public Overrides Function prepare() As Boolean
        If MyBase.prepare() Then
            t = New slimheapless_threadpool2()
...
'finish slimheapless_threadpool2_test.vbp --------
