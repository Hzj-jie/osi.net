...
'with slimheapless_runner_synchronize_invoke_test.vbp ----------
'so change slimheapless_runner_synchronize_invoke_test.vbp instead of this file
...
Public Class slimheapless_runner_synchronize_invoke_test
    Inherits [case]

    Private Shared Function invoke_asynchronously_case() As Boolean
        Dim t As slimheapless_runner = Nothing
        t = New slimheapless_runner()
        Dim s As slimheapless_runner_synchronize_invoke = Nothing
        s = New slimheapless_runner_synchronize_invoke(t)
...
'finish slimheapless_runner_synchronize_invoke_test.vbp --------
