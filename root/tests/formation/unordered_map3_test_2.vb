...
'with unordered_map3_test.vbp ----------
'so change unordered_map3_test.vbp instead of this file
...
Friend Class unordered_map3_case
    Inherits random_run_case

    Private ReadOnly m As unordered_map3(Of String, UInt32) = Nothing
    ...
    Public Sub New(ByVal validate As Boolean)
        m = New unordered_map3(Of String, UInt32)()
        If validate Then
            v = New [set](Of String)()
        End If
    ...
    Private Sub clear()
        If validate() Then
            Dim it As unordered_map3(Of String, UInt32).iterator = Nothing
            it = m.begin()
            Dim c As Int64 = 0
            While it <> m.end()
...
#End If
    ...
    Private Sub clone()
        Dim m2 As unordered_map3(Of String, UInt32) = Nothing
        copy(m2, m)
        ...
        If validate() Then
            ...
            Dim cmp As void(Of unordered_map3(Of String, UInt32), unordered_map3(Of String, UInt32)) =
...
Public Class unordered_map3_test
    ...
    Public Sub New()
        MyBase.New(New unordered_map3_case(True), round())
    End Sub
End Class

Public Class unordered_map3_perf
    ...
    Public Sub New()
        MyBase.New(repeat(New unordered_map3_case(False), round()))
    End Sub
...
End Class
'finish map_case.vbp --------
'finish unordered_map3_test.vbp --------
