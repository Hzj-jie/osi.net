...
Public NotInheritable Class hashset_case(Of T)
    ...
    Private Sub clone()
        Dim h2 As hashset(Of T) = Nothing
        copy(h2, h)
    ...
    Private Sub traversal()
        Dim it As hashset(Of T).iterator = Nothing
        it = h.begin()
        Dim c As UInt32 = 0
        While it <> h.end()
            c += uint32_1
...
Public Class hashset_test(Of T)
    Inherits repeat_case_wrapper

    Public Sub New()
        MyBase.New(New hashset_case(Of T)(), 1024 * 64)
    End Sub
End Class

Public Class hashset_uint_test
    Inherits hashset_test(Of UInt32)
End Class

Public Class hashset_string_test
    Inherits hashset_test(Of String)
End Class
