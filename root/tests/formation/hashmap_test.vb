...
'with hashmap_test.vbp ----------
'so change hashmap_test.vbp instead of this file
...
Friend Class hashmap_case
    Inherits random_run_case

    Private ReadOnly m As hashmap(Of String, UInt32) = Nothing
    ...
    Public Sub New(ByVal validate As Boolean)
        m = New hashmap(Of String, UInt32)()
        If validate Then
            v = New [set](Of String)()
        End If
    ...
    Private Sub clear()
        If validate() Then
            Dim it As hashmap(Of String, UInt32).iterator = Nothing
            it = m.begin()
            Dim c As Int64 = 0
            While it <> m.end()
...
#End If
    ...
    Private Sub clone()
        ...
        If validate() Then
            ...
            Dim cmp As void(Of hashmap(Of String, UInt32), hashmap(Of String, UInt32)) =
...
Public Class hashmap_test
    ...
    Public Sub New()
        MyBase.New(New hashmap_case(True), round())
    End Sub
End Class

Public Class hashmap_perf
    ...
    Public Sub New()
        MyBase.New(repeat(New hashmap_case(False), round()))
    End Sub
