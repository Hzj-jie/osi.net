...
Public Class unordered_map3_case(Of KEY_T, VALUE_T)
    Inherits random_run_case

    Private ReadOnly u As unordered_map3(Of KEY_T, VALUE_T)
    Private ReadOnly m As map(Of KEY_T, VALUE_T)

    Public Sub New()
        u = New unordered_map3(Of KEY_T, VALUE_T)()
    ...
    Private Function random_select_key_from_u() As KEY_T
        ...
        Dim it As unordered_map3(Of KEY_T, VALUE_T).iterator = Nothing
        it = u.begin()
        Dim c As UInt32 = 0
    ...
    Private Sub clone()
        Dim u2 As unordered_map3(Of KEY_T, VALUE_T) = Nothing
        copy(u2, u)
...
Public Class unordered_map3_test(Of KEY_T, VALUE_T)
    Inherits repeat_case_wrapper

    Public Sub New()
        MyBase.New(New unordered_map3_case(Of KEY_T, VALUE_T), 1024 * 16)
    End Sub
End Class

Public Class unordered_map3_uint_test
    Inherits unordered_map3_test(Of UInt32, UInt32)
End Class

Public Class unordered_map3_string_test
    Inherits unordered_map3_test(Of String, String)
End Class
