...
'with qless2_case5.vbp ----------
'so change qless2_case5.vbp instead of this file
...
Friend Class qless2_case5
    ...
    Private Class case5
        ...
        Private ReadOnly q As qless2(Of Int32)
