...
'with bmap_test.vbp ----------
'so change bmap_test.vbp instead of this file
...
Friend Class bmap_case
    Inherits random_run_case

    Private ReadOnly m As bmap(Of String, UInt32) = Nothing
    ...
    Private Sub insert()
        ...
        k = rnd_key()
        assert_equal(m.insert(k, value(k)), m.find(k))
        If validate() Then
            v.insert(k)
        End If
    End Sub
    ...
    Private Function rnd_it() As [set](Of String).iterator
        ...
        it = v.begin()
        For i As Int32 = 0 To rnd_int(0, v.size()) - 1
            it += 1
        Next
        assert(it <> v.end())
        Return it
    ...
    Private Sub clear()
        If validate() Then
            Dim it As bmap(Of String, UInt32).iterator = Nothing
            it = m.begin()
            Dim c As Int64 = 0
            While it <> m.end()
...
#End If
    ...
    Private Sub clone()
        Dim m2 As bmap(Of String, UInt32) = Nothing
        copy(m2, m)
        ...
        If validate() Then
            ...
            Dim cmp As void(Of bmap(Of String, UInt32), bmap(Of String, UInt32)) =
...
Public Class bmap_test
    ...
    Public Sub New()
        MyBase.New(New bmap_case(True), round())
    End Sub
End Class

Public Class bmap_perf
    ...
    Public Sub New()
        MyBase.New(repeat(New bmap_case(False), round()))
    End Sub

    Protected Overrides Function max_loops() As UInt64
        Return If(isreleasebuild(), 250000000000, 30000000000)
    End Function
End Class
'finish map_case.vbp --------
'finish bmap_test.vbp --------
