...
Friend NotInheritable Class set_case
...
#If True Then
        Dim r As tuple(Of [set](Of String).iterator, Boolean) = s.insert(k)
...
#End If
    ...
    Private Sub clear()
        If validate() Then
            Dim it As [set](Of String).iterator = s.begin()
            Dim c As Int64 = 0
            While it <> s.end()
...
Public NotInheritable Class set_perf
...
Public NotInheritable Class set_test
