...
'with omap_test.vbp ----------
'so change omap_test.vbp instead of this file
...
Friend Class omap_case
    Inherits random_run_case

    Private ReadOnly m As omap(Of String, UInt32) = Nothing
...
#End If
    ...
    Private Sub clone()
        Dim m2 As omap(Of String, UInt32) = Nothing
        copy(m2, m)
...
Public Class omap_test
    ...
    Public Sub New()
        MyBase.New(New omap_case(True), round())
    End Sub
End Class

Public Class omap_perf
    ...
    Public Sub New()
        MyBase.New(repeat(New omap_case(False), round()))
    End Sub
