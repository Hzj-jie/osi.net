...
'with smap_test.vbp ----------
'so change smap_test.vbp instead of this file
...
Friend Class smap_case
    Inherits random_run_case

    Private ReadOnly m As smap(Of String, UInt32) = Nothing
...
#End If
    ...
    Private Sub clone()
        Dim m2 As smap(Of String, UInt32) = Nothing
        copy(m2, m)
        ...
        If validate() Then
            ...
            Dim cmp As void(Of smap(Of String, UInt32), smap(Of String, UInt32)) =
...
Public Class smap_test
    ...
    Public Sub New()
        MyBase.New(New smap_case(True), round())
    End Sub
End Class
...
Public Class smap_perf
    ...
    Public Sub New()
        MyBase.New(repeat(New smap_case(False), round()))
    End Sub
