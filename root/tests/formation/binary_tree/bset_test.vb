...
'with bset_test.vbp ----------
'so change bset_test.vbp instead of this file
...
Friend NotInheritable Class bset_case
    Inherits random_run_case

    Private ReadOnly s As [bset](Of String) = Nothing
...
#End If
    ...
    Private Sub clone()
        Dim s2 As [bset](Of String) = Nothing
        copy(s2, s)
    ...
    Private Sub clear()
        If validate() Then
            Dim it As [bset](Of String).iterator = s.begin()
            Dim c As Int64 = 0
            While it <> s.end()
...
Public NotInheritable Class bset_perf
    ...
    Public Sub New()
        MyBase.New(repeat(New bset_case(False), round()))
    End Sub
...
Public NotInheritable Class bset_test
    ...
    Public Sub New()
        MyBase.New(New bset_case(True), round())
    End Sub
End Class
'finish set_case.vbp --------
'finish bset_test.vbp --------
