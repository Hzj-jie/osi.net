...
'with sset_test.vbp ----------
'so change sset_test.vbp instead of this file
...
Friend NotInheritable Class sset_case
    Inherits random_run_case

    Private ReadOnly s As [sset](Of String) = Nothing
...
#If True Then
        Dim r As tuple(Of [sset](Of String).iterator, Boolean) = s.insert(k)
...
#End If
    ...
    Private Sub clear()
        If validate() Then
            Dim it As [sset](Of String).iterator = s.begin()
            Dim c As Int64 = 0
            While it <> s.end()
...
Public NotInheritable Class sset_perf
    ...
    Public Sub New()
        MyBase.New(repeat(New sset_case(False), round()))
    End Sub
...
Public NotInheritable Class sset_test
    ...
    Public Sub New()
        MyBase.New(New sset_case(True), round())
    End Sub
End Class
'finish set_case.vbp --------
'finish sset_test.vbp --------
