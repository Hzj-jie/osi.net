...
'with unordered_set2_test.vbp ----------
'so change unordered_set2_test.vbp instead of this file
...
Friend Class unordered_set2_case
    Inherits random_run_case

    Private ReadOnly s As [unordered_set2](Of String) = Nothing
    ...
    Public Sub New(ByVal validate As Boolean)
        s = New [unordered_set2](Of String)()
        If validate Then
    ...
    Private Sub insert()
        ...
        k = rnd_key()
#If True Then
        Dim r As tuple(Of [unordered_set2](Of String).iterator, Boolean) = Nothing
        r = s.insert(k)
...
#End If
    ...
    Private Sub clone()
        Dim s2 As [unordered_set2](Of String) = Nothing
        copy(s2, s)
        ...
        sz = s.size()
        Dim c As Int64 = 0
        Dim it As [unordered_set2](Of String).iterator = Nothing

        Dim cmp As void(Of [unordered_set2](Of String), [unordered_set2](Of String)) =
...
Public Class unordered_set2_perf
    ...
    Public Sub New()
        MyBase.New(repeat(New unordered_set2_case(False), round()))
    End Sub

    Protected Overrides Function max_loops() As UInt64
        Return CULng(If(isdebugbuild(), 6000000000, 20000000000))
    End Function
End Class

Public Class unordered_set2_test
    ...
    Public Sub New()
        MyBase.New(New unordered_set2_case(True), round())
    End Sub
End Class
'finish set_case.vbp --------
'finish unordered_set2_test.vbp --------
