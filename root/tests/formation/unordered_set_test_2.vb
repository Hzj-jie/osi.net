...
'with unordered_set_test.vbp ----------
'so change unordered_set_test.vbp instead of this file
...
#If True Then
        Dim r As tuple(Of [unordered_set](Of String).iterator, Boolean) = s.insert(k)
...
#End If
    ...
    Private Sub clone()
        Dim s2 As [unordered_set](Of String) = Nothing
        copy(s2, s)
        ...
        Dim c As Int64 = 0
        Dim it As [unordered_set](Of String).iterator = Nothing
...
Public NotInheritable Class unordered_set_perf
    ...
    Public Sub New()
        MyBase.New(repeat(New unordered_set_case(False), round()))
    End Sub
...
Public NotInheritable Class unordered_set_test
    ...
    Public Sub New()
        MyBase.New(New unordered_set_case(True), round())
    End Sub
End Class
'finish set_case.vbp --------
'finish unordered_set_test.vbp --------
