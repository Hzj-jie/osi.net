...
#Disable Warning BC42333
    Implements IComparable,
               IComparable(Of weak_ref(Of T)),
               IComparable(Of T),
               ICloneable,
               ICloneable(Of weak_ref(Of T)),
               IEquatable(Of weak_ref(Of T)),
               IEquatable(Of T)
#Enable Warning BC42333

    Shared Sub New()
        bytes_serializer(Of weak_ref(Of T)).forward_registration.from(Of T)()
    End Sub
...
#End If
    ...
    Public NotOverridable Overrides Function Equals(ByVal that As Object) As Boolean
        Return Equals(cast(Of weak_ref(Of T))().from(that, False))
    End Function
