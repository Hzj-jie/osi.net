...
'with weak_ref.vbp ----------
'so change weak_ref.vbp instead of this file
...
Public Module _weak_ref
    <MethodImpl(method_impl_options.aggressive_inlining)>
    <Extension()> Public Function renew(Of T)(ByRef i As weak_ref(Of T)) As weak_ref(Of T)
...
Public NotInheritable Class weak_ref
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function [of](Of T)(ByVal i As T) As weak_ref(Of T)
        Return New weak_ref(Of T)(i)
    End Function
...
Public Class weak_ref(Of T)
    Implements IComparable, IComparable(Of weak_ref(Of T)), IComparable(Of T),
               ICloneable, ICloneable(Of weak_ref(Of T))

    Private Shared ReadOnly run_shared_sub_new As cctor_delegator =
        New cctor_delegator(AddressOf bytes_serializer(Of weak_ref(Of T)).forward_registration.from(Of T))

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function move(ByVal that As weak_ref(Of T)) As weak_ref(Of T)
...
'finish weak_ref.override.vbp --------
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CompareTo(ByVal that As weak_ref(Of T)) As Int32 _
                             Implements IComparable(Of weak_ref(Of T)).CompareTo
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CloneT() As weak_ref(Of T) Implements ICloneable(Of weak_ref(Of T)).Clone
        Return New weak_ref(Of T)(Me)
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Operator +(ByVal p As weak_ref(Of T)) As T
        Return If(p Is Nothing, Nothing, p.get())
    End Operator

    'special treatment for ref, it compares reference equaling, instead of internal object
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Operator <>(ByVal this As weak_ref(Of T), ByVal that As weak_ref(Of T)) As Boolean
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Operator <>(ByVal this As weak_ref(Of T), ByVal that As T) As Boolean
        Return Not this = that
    End Operator
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Operator <>(ByVal this As T, ByVal that As weak_ref(Of T)) As Boolean
        Return Not this = that
    End Operator
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Operator =(ByVal this As Object, ByVal that As weak_ref(Of T)) As Boolean
        Return that = this
    End Operator
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Widening Operator CType(ByVal this As weak_ref(Of T)) As Boolean
        Return Not this Is Nothing AndAlso Not this.empty()
    End Operator

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Narrowing Operator CType(ByVal i As T) As weak_ref(Of T)
        Return New weak_ref(Of T)(i)
    End Operator

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Narrowing Operator CType(ByVal i As weak_ref(Of T)) As T
        Return +i
    End Operator

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Operator Not(ByVal this As weak_ref(Of T)) As Boolean
