...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function bytes_bool(
        ...
        If bytes_bool(i, offset, sizeof_bool, o) Then
            offset += sizeof_bool
            Return True
        Else
            Return False
...
#End If
    ...
    Public Function bool_bytes(
                        ...
                        ByVal d() As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If array_size(d) >= offset + sizeof_bool Then
#If IS_BYTE Then
            d(CInt(offset)) = i
#Else
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function big_endian_bytes_bool(
                        ...
                        ByRef o As Boolean,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If big_endian_bytes_bool(i, offset, sizeof_bool, o) Then
            offset += sizeof_bool
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function little_endian_bytes_bool(
                        ...
                        ByRef o As Boolean,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If little_endian_bytes_bool(i, offset, sizeof_bool, o) Then
            offset += sizeof_bool
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function bytes_sbyte(
                        ...
                        ByRef o As SByte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If bytes_sbyte(i, offset, sizeof_sbyte, o) Then
            offset += sizeof_sbyte
            Return True
        Else
            Return False
...
#End If
    ...
    Public Function sbyte_bytes(
                        ...
                        ByVal d() As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If array_size(d) >= offset + sizeof_sbyte Then
#If IS_BYTE Then
            d(CInt(offset)) = i
#Else
            Dim t() As Byte = Nothing
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function big_endian_bytes_sbyte(
                        ...
                        ByRef o As SByte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If big_endian_bytes_sbyte(i, offset, sizeof_sbyte, o) Then
            offset += sizeof_sbyte
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function little_endian_bytes_sbyte(
                        ...
                        ByRef o As SByte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If little_endian_bytes_sbyte(i, offset, sizeof_sbyte, o) Then
            offset += sizeof_sbyte
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function bytes_int8(
                        ...
                        ByRef o As SByte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If bytes_int8(i, offset, sizeof_int8, o) Then
            offset += sizeof_int8
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function big_endian_bytes_int8(
                        ...
                        ByRef o As SByte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If big_endian_bytes_int8(i, offset, sizeof_int8, o) Then
            offset += sizeof_int8
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function little_endian_bytes_int8(
                        ...
                        ByRef o As SByte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If little_endian_bytes_int8(i, offset, sizeof_int8, o) Then
            offset += sizeof_int8
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function bytes_uint8(
                        ...
                        ByRef o As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If bytes_uint8(i, offset, sizeof_uint8, o) Then
            offset += sizeof_uint8
            Return True
        Else
            Return False
...
#End If
    ...
    Public Function uint8_bytes(
                        ...
                        ByVal d() As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If array_size(d) >= offset + sizeof_uint8 Then
#If IS_BYTE Then
            d(CInt(offset)) = i
#Else
            Dim t() As Byte = Nothing
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function big_endian_bytes_uint8(
                        ...
                        ByRef o As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If big_endian_bytes_uint8(i, offset, sizeof_uint8, o) Then
            offset += sizeof_uint8
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function little_endian_bytes_uint8(
                        ...
                        ByRef o As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If little_endian_bytes_uint8(i, offset, sizeof_uint8, o) Then
            offset += sizeof_uint8
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function bytes_uint16(
                        ...
                        ByRef o As UInt16,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If bytes_uint16(i, offset, sizeof_uint16, o) Then
...
#End If
    ...
    Public Function uint16_bytes(
                        ...
                        ByVal d() As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If array_size(d) >= offset + sizeof_uint16 Then
#If IS_BYTE Then
            d(CInt(offset)) = i
#Else
            Dim t() As Byte = Nothing
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function big_endian_bytes_uint16(
                        ...
                        ByRef o As UInt16,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If big_endian_bytes_uint16(i, offset, sizeof_uint16, o) Then
            offset += sizeof_uint16
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function little_endian_bytes_uint16(
                        ...
                        ByRef o As UInt16,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If little_endian_bytes_uint16(i, offset, sizeof_uint16, o) Then
            offset += sizeof_uint16
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function bytes_char(
                        ...
                        ByRef o As Char,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If bytes_char(i, offset, sizeof_char, o) Then
            offset += sizeof_char
            Return True
        Else
            Return False
...
#End If
    ...
    Public Function char_bytes(
                        ...
                        ByVal d() As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If array_size(d) >= offset + sizeof_char Then
#If IS_BYTE Then
            d(CInt(offset)) = i
#Else
            Dim t() As Byte = Nothing
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function big_endian_bytes_char(
                        ...
                        ByRef o As Char,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If big_endian_bytes_char(i, offset, sizeof_char, o) Then
            offset += sizeof_char
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function little_endian_bytes_char(
                        ...
                        ByRef o As Char,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If little_endian_bytes_char(i, offset, sizeof_char, o) Then
            offset += sizeof_char
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function bytes_uint32(
                        ...
                        ByRef o As UInt32,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If bytes_uint32(i, offset, sizeof_uint32, o) Then
...
#End If
    ...
    Public Function uint32_bytes(
                        ...
                        ByVal d() As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If array_size(d) >= offset + sizeof_uint32 Then
#If IS_BYTE Then
            d(CInt(offset)) = i
#Else
            Dim t() As Byte = Nothing
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function big_endian_bytes_uint32(
                        ...
                        ByRef o As UInt32,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If big_endian_bytes_uint32(i, offset, sizeof_uint32, o) Then
            offset += sizeof_uint32
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function little_endian_bytes_uint32(
                        ...
                        ByRef o As UInt32,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If little_endian_bytes_uint32(i, offset, sizeof_uint32, o) Then
            offset += sizeof_uint32
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function bytes_uint64(
                        ...
                        ByRef o As UInt64,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If bytes_uint64(i, offset, sizeof_uint64, o) Then
            offset += sizeof_uint64
            Return True
        Else
            Return False
        End If
...
#End If
    ...
    Public Function uint64_bytes(
                        ...
                        ByVal d() As Byte,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If array_size(d) >= offset + sizeof_uint64 Then
#If IS_BYTE Then
            d(CInt(offset)) = i
#Else
            Dim t() As Byte = Nothing
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function big_endian_bytes_uint64(
                        ...
                        ByRef o As UInt64,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If big_endian_bytes_uint64(i, offset, sizeof_uint64, o) Then
            offset += sizeof_uint64
            Return True
        Else
            Return False
...
'so change bytes_dependent_impl.vbp instead of this file
    ...
    Public Function little_endian_bytes_uint64(
                        ...
                        ByRef o As UInt64,
                        Optional ByRef offset As UInt32 = uint32_0) As Boolean
        If little_endian_bytes_uint64(i, offset, sizeof_uint64, o) Then
            offset += sizeof_uint64
            Return True
        Else
            Return False
