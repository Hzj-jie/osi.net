...
Public NotInheritable Class type_info(Of T)
    ...
    Public Shared Function is_cloneable() As Boolean
        Return type_info(Of T, type_info_operators.is, ICloneable).v
    End Function

    Public Shared Function is_delegate() As Boolean
        Return type_info(Of T, type_info_operators.is, [Delegate]).v
    End Function
