...
Partial Public Structure size_t
    Implements IComparable, IComparable(Of size_t), ICloneable
    ...
    Shared Sub New()
        ...
        inf = New size_t(constants.npos)
        assert(inf.npos())
        zero = New size_t(uint32_0)
        If True Then
...
'finish npos_uint_ctor.vbp --------
    ...
    Public Shared Function to_bytes(ByVal this As size_t) As Byte()
...
#End If
    ...
    Public Shared Function to_bytes(ByVal this As size_t, ByRef o() As Byte) As Boolean
        o = to_bytes(this)
        Return True
    End Function
    ...
    Public Shared Function to_bytes(ByVal this As size_t,
                                    ByVal o() As Byte,
