...
Partial Public Structure positive_npos_uint32
    Implements IComparable, IComparable(Of positive_npos_uint32), ICloneable
    ...
    Shared Sub New()
        ...
        inf = New positive_npos_uint32(constants.npos)
        assert(inf.npos())
        zero = New positive_npos_uint32(uint32_0)
        If False Then
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As SByte) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As Byte) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Int16) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As UInt16) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Int32) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As UInt32) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Int64) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As UInt64) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Decimal) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator

#If False Then
    Public Shared Widening Operator CType(ByVal this As UDecimal) As positive_npos_uint32
        Return New positive_npos_uint32(this)
    End Operator
#End If
...
'finish npos_uint_ctor.vbp --------
    ...
    Public Sub New(ByVal that As positive_npos_uint32)
        i = that.i
        n = that.n
    End Sub

    Public Shared Function to_bytes(ByVal this As positive_npos_uint32) As Byte()
...
#End If
    ...
    Public Shared Function to_bytes(ByVal this As positive_npos_uint32, ByRef o() As Byte) As Boolean
        o = to_bytes(this)
        Return True
    End Function
    ...
    Public Shared Function to_bytes(ByVal this As positive_npos_uint32,
                                    ByVal o() As Byte,
...
#End If
    ...
    Public Shared Function from_bytes(ByVal b() As Byte,
                                      ByVal ii As UInt32,
                                      ByVal il As UInt32,
                                      ByRef o As positive_npos_uint32) As Boolean
#If Not False OrElse Not True Then
...
#End If
    ...
    Public Shared Function from_bytes(ByVal b() As Byte,
                                      ByRef o As positive_npos_uint32,
...
#End If
    ...
    Public Shared Operator =(ByVal this As positive_npos_uint32, ByVal that As positive_npos_uint32) As Boolean
    ...
    Public Shared Operator =(ByVal this As positive_npos_uint32, ByVal that As Int32) As Boolean
    ...
    Public Shared Operator =(ByVal this As Int32, ByVal that As positive_npos_uint32) As Boolean
        Return that = this
    End Operator
    ...
    Public Shared Operator =(ByVal this As positive_npos_uint32, ByVal that As UInt32) As Boolean
        If this.npos() Then
            Return False
        Else
    ...
    Public Shared Operator =(ByVal this As UInt32, ByVal that As positive_npos_uint32) As Boolean
        Return that = this
    End Operator
    ...
    Public Shared Widening Operator CType(ByVal this As positive_npos_uint32) As Int32
        If this.npos() Then
    ...
    Public Shared Widening Operator CType(ByVal this As positive_npos_uint32) As UInt32
        assert(Not this.npos())
        Return this.raw_value()
    End Operator

#If True Then
    Public Shared Operator +(Byval this As positive_npos_uint32) As UInt32
        Return this.raw_value()
    End Operator    
#End If
    ...
    Public Function CompareTo(ByVal that As positive_npos_uint32) As Int32 Implements IComparable(Of positive_npos_uint32).CompareTo
    ...
    Public Function CompareTo(ByVal that As Object) As Int32 Implements IComparable.CompareTo
        Dim other As positive_npos_uint32 = Nothing
        If cast(Of positive_npos_uint32)(that, other) Then
    ...
    Public Function Clone() As Object Implements ICloneable.Clone
        Return New positive_npos_uint32(Me)
    End Function
End Structure
