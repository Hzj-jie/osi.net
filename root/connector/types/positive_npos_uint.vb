...
Partial Public Structure positive_npos_uint
    ...
    Shared Sub New()
        ...
        inf = New positive_npos_uint(constants.npos)
        assert(inf.npos())
        zero = New positive_npos_uint(uint32_0)
        If False Then
...
'finish npos_uint_ctor.vbp --------
    ...
    Public Shared Function to_bytes(ByVal this As positive_npos_uint) As Byte()
...
#End If
    ...
    Public Shared Function to_bytes(ByVal this As positive_npos_uint, ByRef o() As Byte) As Boolean
        o = to_bytes(this)
        Return True
    End Function
    ...
    Public Shared Function to_bytes(ByVal this As positive_npos_uint,
                                    ByVal o() As Byte,
...
#End If
    ...
    Public Shared Function from_bytes(ByVal b() As Byte,
                                      ByVal ii As UInt32,
                                      ByVal il As UInt32,
                                      ByRef o As positive_npos_uint) As Boolean
#If Not False OrElse Not True Then
