...
Partial Public Structure retry_times_t
    ...
    Shared Sub New()
        ...
        inf = New retry_times_t(constants.npos)
        assert(inf.npos())
        zero = New retry_times_t(uint32_0)
        If True Then
...
'finish npos_uint_ctor.vbp --------
    ...
    Public Shared Function to_bytes(ByVal this As retry_times_t) As Byte()
...
#End If
    ...
    Public Shared Function to_bytes(ByVal this As retry_times_t, ByRef o() As Byte) As Boolean
        o = to_bytes(this)
        Return True
    End Function
    ...
    Public Shared Function to_bytes(ByVal this As retry_times_t,
                                    ByVal o() As Byte,
...
#End If
    ...
    Public Shared Function from_bytes(ByVal b() As Byte,
                                      ByVal ii As UInt32,
                                      ByVal il As UInt32,
                                      ByRef o As retry_times_t) As Boolean
#If Not True OrElse Not False Then
