...
Partial Public Structure positive_size_t
    Implements IComparable, IComparable(Of positive_size_t), ICloneable
    ...
    Shared Sub New()
        ...
        sizeof_value = sizeof(Of UInt32)()
        Dim x As positive_size_t = Nothing
        assert(Not x.npos())
        assert(x.raw_value() = uint32_0)
        inf = New positive_size_t(constants.npos)
        assert(inf.npos())
        zero = New positive_size_t(uint32_0)
        If False Then
...
'finish npos_uint_ctor.vbp --------
    ...
    Public Shared Function to_bytes(ByVal this As positive_size_t) As Byte()
...
#End If
    ...
    Public Shared Function to_bytes(ByVal this As positive_size_t, ByRef o() As Byte) As Boolean
        o = to_bytes(this)
        Return True
    End Function
    ...
    Public Shared Function to_bytes(ByVal this As positive_size_t,
                                    ByVal o() As Byte,
...
#End If
    ...
    Public Shared Function from_bytes(ByVal b() As Byte,
                                      ByVal ii As UInt32,
                                      ByVal il As UInt32,
                                      ByRef o As positive_size_t) As Boolean
#If Not False OrElse Not True Then
