...
Partial Public Structure positive_size_t_32
    Implements IComparable, IComparable(Of positive_size_t_32), ICloneable

    Public Shared ReadOnly inf As positive_size_t_32
    Public Shared ReadOnly zero As positive_size_t_32
    ...
    Shared Sub New()
        ...
        inf = New positive_size_t_32(constants.npos)
        assert(inf.npos())
        zero = New positive_size_t_32(uint32_0)
        If False Then
...
'finish npos_uint_ctor.vbp --------
    ...
    Public Shared Function to_bytes(ByVal this As positive_size_t_32) As Byte()
...
#End If
    ...
    Public Shared Function to_bytes(ByVal this As positive_size_t_32, ByRef o() As Byte) As Boolean
        o = to_bytes(this)
        Return True
    End Function
    ...
    Public Shared Function to_bytes(ByVal this As positive_size_t_32,
                                    ByVal o() As Byte,
...
#End If
    ...
    Public Shared Function from_bytes(ByVal b() As Byte,
                                      ByVal ii As UInt32,
                                      ByVal il As UInt32,
                                      ByRef o As positive_size_t_32) As Boolean
#If Not False OrElse Not True Then
