...
Public Module _bit
    ...
    Sub New()
        jump_size = bit_count_in_byte * sizeof_uint64
        ...
        bit_count_in_int8 = bit_count_in_byte * sizeof_int8
        bit_count_in_int16 = bit_count_in_byte * sizeof_int16
        bit_count_in_int32 = bit_count_in_byte * sizeof_int32
        bit_count_in_int64 = bit_count_in_byte * sizeof_int64
    ...
    <Extension()> Public Function getbit(ByVal b As Byte, ByVal index As Byte) As Boolean
        ...
        Return (b And jump1(index + int8_offset))
    End Function

    <Extension()> Public Sub setbit(ByRef b As Byte, ByVal index As Byte, Optional ByVal value As Boolean = True)
        assert_index_int8(index)
        If value Then
            b = (b Or jump1(index + int8_offset))
        Else
            b = (b And jump0(index + int8_offset))
        End If
    End Sub

    <Extension()> Public Function getrbit(ByVal b As Byte, ByVal index As Byte) As Boolean
        assert_index_int8(index)
        Return (b And rjump1(index))
    End Function

    <Extension()> Public Sub setrbit(ByRef b As Byte, ByVal index As Byte, Optional ByVal value As Boolean = True)
        assert_index_int8(index)
        If value Then
            b = (b Or rjump1(index))
        Else
    ...
    <Extension()> Public Sub setbit(ByRef b As SByte, ByVal index As Byte, Optional ByVal value As Boolean = True)
        Dim c As Byte = 0
        c = int8_uint8(b)
    ...
    <Extension()> Public Sub setrbit(ByRef b As SByte, ByVal index As Byte, Optional ByVal value As Boolean = True)
        Dim c As Byte = 0
        c = int8_uint8(b)
    ...
    <Extension()> Public Function getbit(ByVal b As UInt16, ByVal index As Byte) As Boolean
        ...
        Return (b And jump1(index + int16_offset))
    End Function

    <Extension()> Public Sub setbit(ByRef b As UInt16, ByVal index As Byte, Optional ByVal value As Boolean = True)
        assert_index_int16(index)
        If value Then
            b = (b Or jump1(index + int16_offset))
        Else
            b = (b And jump0(index + int16_offset))
        End If
    End Sub
    ...
    <Extension()> Public Sub setrbit(ByRef b As UInt16, ByVal index As Byte, Optional ByVal value As Boolean = True)
        assert_index_int16(index)
        If value Then
            b = (b Or rjump1(index))
        Else
    ...
    <Extension()> Public Sub setbit(ByRef b As Int16, ByVal index As Byte, Optional ByVal value As Boolean = True)
        Dim c As UInt16 = 0
        c = int16_uint16(b)
        setbit(c, index, value)
        b = uint16_int16(c)
    ...
    <Extension()> Public Sub setrbit(ByRef b As Int16, ByVal index As Byte, Optional ByVal value As Boolean = True)
        Dim c As UInt16 = 0
        c = int16_uint16(b)
        setrbit(c, index, value)
        b = uint16_int16(c)
    ...
    <Extension()> Public Function getbit(ByVal b As UInt32, ByVal index As Byte) As Boolean
        ...
        Return (b And jump1(index + int32_offset))
    End Function

    <Extension()> Public Sub setbit(ByRef b As UInt32, ByVal index As Byte, Optional ByVal value As Boolean = True)
        assert_index_int32(index)
        If value Then
            b = (b Or jump1(index + int32_offset))
        Else
            b = (b And jump0(index + int32_offset))
        End If
    End Sub
    ...
    <Extension()> Public Sub setrbit(ByRef b As UInt32, ByVal index As Byte, Optional ByVal value As Boolean = True)
        assert_index_int32(index)
        If value Then
            b = (b Or rjump1(index))
        Else
    ...
    <Extension()> Public Sub setbit(ByRef b As Int32, ByVal index As Byte, Optional ByVal value As Boolean = True)
        Dim c As UInt32 = 0
        c = int32_uint32(b)
        setbit(c, index, value)
        b = uint32_int32(c)
    ...
    <Extension()> Public Sub setrbit(ByRef b As Int32, ByVal index As Byte, Optional ByVal value As Boolean = True)
        Dim c As UInt32 = 0
        c = int32_uint32(b)
        setrbit(c, index, value)
        b = uint32_int32(c)
    ...
    <Extension()> Public Function getbit(ByVal b As UInt64, ByVal index As Byte) As Boolean
        ...
        Return (b And jump1(index + int64_offset))
    End Function

    <Extension()> Public Sub setbit(ByRef b As UInt64, ByVal index As Byte, Optional ByVal value As Boolean = True)
        assert_index_int64(index)
        If value Then
    ...
    <Extension()> Public Sub setrbit(ByRef b As UInt64, ByVal index As Byte, Optional ByVal value As Boolean = True)
        assert_index_int64(index)
        If value Then
            b = (b Or rjump1(index))
        Else
    ...
    <Extension()> Public Sub setbit(ByRef b As Int64, ByVal index As Byte, Optional ByVal value As Boolean = True)
        Dim c As UInt64 = 0
        c = int64_uint64(b)
        setbit(c, index, value)
        b = uint64_int64(c)
    ...
    <Extension()> Public Sub setrbit(ByRef b As Int64, ByVal index As Byte, Optional ByVal value As Boolean = True)
        Dim c As UInt64 = 0
        c = int64_uint64(b)
        setrbit(c, index, value)
        b = uint64_int64(c)
    ...
    <Extension()> Public Function bit_bytes(ByVal s As String,
        ...
        Else
            Dim j As Int32 = 0
            j = start
            For i As Int32 = 0 To strlen(s) - 1 Step bit_count_in_byte
