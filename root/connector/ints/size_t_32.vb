...
Partial Public Structure size_t_32
    ...
    Public Shared ReadOnly inf As size_t_32 = calculate_inf()
    Public Shared ReadOnly zero As size_t_32 = calculate_zero()
    Public Shared ReadOnly sizeof_value As UInt32 = CUInt(sizeof(Of UInt32)())

    Private Shared Function calculate_inf() As size_t_32
        Dim inf As size_t_32 = New size_t_32(constants.npos)
        assert(inf.npos())
        Return inf
    End Function

    Private Shared Function calculate_zero() As size_t_32
        Dim zero As size_t_32 = New size_t_32(uint32_0)
        If True Then
