...
Partial Public Structure size_t_64
    Implements IComparable, IComparable(Of size_t_64), ICloneable
    ...
    Shared Sub New()
        ...
        inf = New size_t_64(constants.npos)
        assert(inf.npos())
        zero = New size_t_64(uint64_0)
        If True Then
...
'finish npos_uint_ctor.vbp --------
    ...
    Public Shared Function to_bytes(ByVal this As size_t_64) As Byte()
...
#End If
    ...
    Public Shared Function to_bytes(ByVal this As size_t_64, ByRef o() As Byte) As Boolean
        o = to_bytes(this)
        Return True
    End Function
    ...
    Public Shared Function to_bytes(ByVal this As size_t_64,
                                    ByVal o() As Byte,
...
#End If
    ...
    Public Shared Function from_bytes(ByVal b() As Byte,
                                      ByVal ii As UInt32,
                                      ByVal il As UInt32,
                                      ByRef o As size_t_64) As Boolean
#If Not True OrElse Not True Then
