...
'with size_t_64.vbp ----------
'so change size_t_64.vbp instead of this file
...
Partial Public Structure size_t_64
    Implements IComparable, IComparable(Of size_t_64), ICloneable, ICloneable(Of size_t_64)

    Public Shared ReadOnly inf As size_t_64 = calculate_inf()
    Public Shared ReadOnly zero As size_t_64 = calculate_zero()
    Public Shared ReadOnly sizeof_value As UInt32 = CUInt(sizeof(Of UInt64)())

    Private Shared Function calculate_inf() As size_t_64
        Dim inf As size_t_64 = New size_t_64(constants.npos)
        assert(inf.npos())
        Return inf
    End Function

    Private Shared Function calculate_zero() As size_t_64
        Dim zero As size_t_64 = New size_t_64(uint64_0)
        If True Then
    ...
    Private Shared ReadOnly run_shared_sub_new As cctor_delegator = New cctor_delegator(
        Sub()
            ...
            bytes_serializer.fixed.register(
                    Function(ByVal i As size_t_64, ByVal o As MemoryStream) As Boolean
                        #If Not True Then
                            If i.npos() Then
                        ...
                        #End If
                    End Function,
                    Function(ByVal i As MemoryStream, ByRef o As size_t_64) As Boolean
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As SByte) As size_t_64
        Return New size_t_64(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As Byte) As size_t_64
        Return New size_t_64(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Int16) As size_t_64
        Return New size_t_64(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As UInt16) As size_t_64
        Return New size_t_64(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Int32) As size_t_64
        Return New size_t_64(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As UInt32) As size_t_64
        Return New size_t_64(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Int64) As size_t_64
        Return New size_t_64(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As UInt64) As size_t_64
        Return New size_t_64(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Decimal) As size_t_64
        Return New size_t_64(this)
    End Operator

#If False Then
    Public Shared Widening Operator CType(ByVal this As UDecimal) As size_t_64
        Return New size_t_64(this)
    End Operator
#End If
...
'finish npos_uint_ctor.vbp --------
    ...
    Public Sub New(ByVal that As size_t_64)
        i = that.i
        n = that.n
    End Sub
...
#End If
    ...
    Public Shared Operator =(ByVal this As size_t_64, ByVal that As size_t_64) As Boolean
    ...
    Public Shared Operator =(ByVal this As size_t_64, ByVal that As Int64) As Boolean
    ...
    Public Shared Operator =(ByVal this As Int64, ByVal that As size_t_64) As Boolean
        Return that = this
    End Operator
    ...
    Public Shared Operator =(ByVal this As size_t_64, ByVal that As UInt64) As Boolean
        If this.npos() Then
            Return False
        Else
    ...
    Public Shared Operator =(ByVal this As UInt64, ByVal that As size_t_64) As Boolean
        Return that = this
    End Operator
    ...
    Public Shared Widening Operator CType(ByVal this As size_t_64) As Int64
        If this.npos() Then
    ...
    Public Shared Widening Operator CType(ByVal this As size_t_64) As UInt64
        assert(Not this.npos())
        Return this.raw_value()
    End Operator

#If True Then
    Public Shared Operator +(Byval this As size_t_64) As UInt64
        Return this.raw_value()
    End Operator    
#End If
    ...
    Public Function CompareTo(ByVal that As size_t_64) As Int32 Implements IComparable(Of size_t_64).CompareTo
    ...
    Public Function CompareTo(ByVal that As Object) As Int32 Implements IComparable.CompareTo
        Dim other As size_t_64 = Nothing
        If cast(Of size_t_64)(that, other) Then
    ...
    Public Function CloneT() As size_t_64 Implements ICloneable(Of size_t_64).Clone
        Return New size_t_64(Me)
    End Function
