...
Partial Public Structure positive_size_t_64
    ...
    Public Shared ReadOnly inf As positive_size_t_64 = calculate_inf()
    Public Shared ReadOnly zero As positive_size_t_64 = calculate_zero()
    Public Shared ReadOnly sizeof_value As UInt32 = CUInt(sizeof(Of UInt64)())

    Private Shared Function calculate_inf() As positive_size_t_64
        Dim inf As positive_size_t_64 = New positive_size_t_64(constants.npos)
        assert(inf.npos())
        Return inf
    End Function

    Private Shared Function calculate_zero() As positive_size_t_64
