...
Partial Public Structure positive_npos_uint
    ...
    Public Shared ReadOnly inf As positive_npos_uint =
        Function() As positive_npos_uint
...
#End If
    ...
    Public Function CompareTo(ByVal that As positive_npos_uint) As Int32 _
        Implements IComparable(Of positive_npos_uint).CompareTo
