...
Partial Public Structure positive_npos_uint
    ...
    Public Shared ReadOnly inf As positive_npos_uint = calculate_inf()
    Public Shared ReadOnly zero As positive_npos_uint = calculate_zero()
    Public Shared ReadOnly sizeof_value As UInt32 = CUInt(sizeof(Of UInt32)())

    Private Shared Function calculate_inf() As positive_npos_uint
        Dim inf As positive_npos_uint = New positive_npos_uint(constants.npos)
        assert(inf.npos())
        Return inf
    End Function

    Private Shared Function calculate_zero() As positive_npos_uint
        Dim zero As positive_npos_uint = New positive_npos_uint(uint32_0)
        If False Then
    ...
    Private Shared ReadOnly run_shared_sub_new As cctor_delegator = New cctor_delegator(
        Sub()
            ...
            bytes_serializer.fixed.register(
                    Function(ByVal i As positive_npos_uint, ByVal o As MemoryStream) As Boolean
                        #If Not False Then
                            If i.npos() Then
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As SByte) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As Byte) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Int16) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As UInt16) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Int32) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As UInt32) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Int64) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator

#If True Then
    Public Shared Widening Operator CType(ByVal this As UInt64) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator
#End If
...
#End If
    ...
    Public Shared Widening Operator CType(ByVal this As Decimal) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator

#If False Then
    Public Shared Widening Operator CType(ByVal this As UDecimal) As positive_npos_uint
        Return New positive_npos_uint(this)
    End Operator
#End If
...
'finish npos_uint_ctor.vbp --------
    ...
    Public Sub New(ByVal that As positive_npos_uint)
        i = that.i
        n = that.n
    End Sub
...
#End If
    ...
    Public Shared Operator =(ByVal this As positive_npos_uint, ByVal that As positive_npos_uint) As Boolean
    ...
    Public Shared Operator =(ByVal this As positive_npos_uint, ByVal that As Int32) As Boolean
    ...
    Public Shared Operator =(ByVal this As Int32, ByVal that As positive_npos_uint) As Boolean
        Return that = this
    End Operator
    ...
    Public Shared Operator =(ByVal this As positive_npos_uint, ByVal that As UInt32) As Boolean
        If this.npos() Then
            Return False
        Else
    ...
    Public Shared Operator =(ByVal this As UInt32, ByVal that As positive_npos_uint) As Boolean
        Return that = this
    End Operator
    ...
    Public Shared Widening Operator CType(ByVal this As positive_npos_uint) As Int32
        If this.npos() Then
    ...
    Public Shared Widening Operator CType(ByVal this As positive_npos_uint) As UInt32
        assert(Not this.npos())
        Return this.raw_value()
    End Operator

#If True Then
    Public Shared Operator +(Byval this As positive_npos_uint) As UInt32
        Return this.raw_value()
    End Operator    
#End If
    ...
    Public Function CompareTo(ByVal that As positive_npos_uint) As Int32 Implements IComparable(Of positive_npos_uint).CompareTo
    ...
    Public Function CompareTo(ByVal that As Object) As Int32 Implements IComparable.CompareTo
        Dim other As positive_npos_uint = Nothing
        If cast(Of positive_npos_uint)(that, other) Then
