...
Partial Public Structure positive_size_t_32
    ...
    Public Shared ReadOnly inf As positive_size_t_32 =
        Function() As positive_size_t_32
...
#End If
    ...
    Public Function CompareTo(ByVal that As positive_size_t_32) As Int32 _
        Implements IComparable(Of positive_size_t_32).CompareTo
