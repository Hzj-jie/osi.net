...
Partial Public Structure npos_uint32
    Implements IComparable, IComparable(Of npos_uint32), ICloneable, ICloneable(Of npos_uint32)

    Public Shared ReadOnly inf As npos_uint32 = calculate_inf()
    Public Shared ReadOnly zero As npos_uint32 = calculate_zero()
    Public Shared ReadOnly sizeof_value As UInt32 = CUInt(sizeof(Of UInt32)())

    Private Shared Function calculate_inf() As npos_uint32
        Dim inf As npos_uint32 = New npos_uint32(constants.npos)
        assert(inf.npos())
        Return inf
    End Function

    Private Shared Function calculate_zero() As npos_uint32
        Dim zero As npos_uint32 = New npos_uint32(uint32_0)
        If True Then
    ...
    Shared Sub New()
        ...
        bytes_serializer.fixed.register(
                Function(ByVal i As npos_uint32, ByVal o As MemoryStream) As Boolean
                    #If Not True Then
                        If i.npos() Then
                    ...
                    #End If
                End Function,
                Function(ByVal i As MemoryStream, ByRef o As npos_uint32) As Boolean
...
#End If
    ...
    Public Function CloneT() As npos_uint32 Implements ICloneable(Of npos_uint32).Clone
