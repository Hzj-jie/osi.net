...
'with atomic_int64.vbp ----------
'so change atomic_int64.vbp instead of this file
...
#End If
    ...
    Public Shared Operator +(ByVal this As atomic_int64(Of LOCK_T)) As Int64
        Return If(this Is Nothing, Nothing, this.get())
    End Operator
End Class


Public Class atomic_int64
    Inherits atomic_int64(Of spinlock)
