...
'with atomic_ref.vbp ----------
'so change atomic_ref.vbp instead of this file
...
Partial Public Class atom_ref(Of LOCK_T As {islimlock, Structure})
    Private p As Object
    Private l As LOCK_T
...
#If GENERIC_TYPE Then
    Shared Sub New()
        raise_error(error_type.performance,
                    "atom_ref(Of LOCK_T) cannot use interlocked operations. Its performance is low.")
    End Sub
#End If
...
#End If
    ...
    Public Sub modify(ByVal d As void(Of Object))
...
#End If
    ...
    Public Shared Operator +(ByVal this As atom_ref(Of LOCK_T)) As Object
        Return If(this Is Nothing, Nothing, this.get())
    End Operator
End Class


Public Class atomic_ref
    Inherits atom_ref(Of spinlock)
