...
Public Class binary_operator_add_protector
    Private Sub New()
    End Sub
End Class

Public Class binary_operator_minus_protector
    Private Sub New()
    End Sub
End Class

Public Class sizeof_binder_protector
    Private Sub New()
    End Sub
End Class

Public Class bytes_conversion_binder_protector
    Private Sub New()
    End Sub
End Class

Public Class uri_conversion_binder_protector
    Private Sub New()
    End Sub
End Class

Public Class string_conversion_binder_protector
    Private Sub New()
    End Sub
End Class

' compare is in connector, while suppress is in utils, it depends on atomic_bool, which is in lock
Public Class suppress_compare_error_binder_protector
    Private Sub New()
    End Sub
End Class

' binder is in connector, while suppress is in utils, it depends on atomic_bool, which is in lock
Public Class suppress_rebind_global_value_error_binder_protector
    Private Sub New()
    End Sub
End Class

' alloc is in connector, while suppress is in utils, it depends on atomic_bool, which is in lock
Public Class suppress_alloc_error_binder_protector
    Private Sub New()
    End Sub
End Class