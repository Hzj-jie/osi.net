...
Public Module _app_info
    ' TODO: In modern .NET on Linux, use Environment.ProcessPath or Assembly.GetEntryAssembly().Location.
    Public ReadOnly application_full_path As String = this_process.ref.MainModule().FileName()
