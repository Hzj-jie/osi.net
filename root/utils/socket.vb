...
Public Module _socket
    ...
    Public Function identity(ByVal local As EndPoint, ByVal remote As EndPoint) As String
    ...
    Private Function poll(ByVal s As Socket, ByVal timeout_ms As Int64, ByVal mode As SelectMode) As Boolean
        ...
        End If
        Try
            Return s.Poll(CInt(milliseconds_to_microseconds(timeout_ms)), mode)
        Catch ex As Exception
            If network_trace Then
                raise_error(error_type.warning,
                            ...
                            ex.Message())
            End If
            Return mode = SelectMode.SelectError OrElse mode = SelectMode.SelectRead
        End Try
    End Function
    ...
    <Extension()> Public Function set_iocontrol(ByVal this As Socket,
        ...
        Return set_iocontrol(this,
                             control_code,
                             Function() io_control_code_to_str(CInt(control_code)),
                             in_value,
                             out_value)
    End Function
    ...
    <Extension()> Public Function set_keepalive(ByVal c As Socket,
        ...
        ReDim v(CInt(sizeof_uint32 * 3 - uint32_1))
    ...
    <Extension()> Public Function enable_keepalive(ByVal c As Socket,
        ...
        Return set_keepalive(c, True, first_keepalive_ms, interval_ms)
    End Function
