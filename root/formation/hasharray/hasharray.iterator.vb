...
#End If
    ...
    'the following code is generated by /osi/root/codegen/precompile/precompile.exe
    'with ..\..\codegen\iterator_to_enumerator.vbp ----------
    'so change ..\..\codegen\iterator_to_enumerator.vbp instead of this file


    Public Structure enumerator
        Implements container_operator(Of T).enumerator

        Private it As hasharray(Of T, _UNIQUE, _HASHER, _EQUALER).iterator
    ...
    'finish ..\..\codegen\iterator_to_enumerator.vbp --------
    ...
    Partial Public Structure iterator
        <MethodImpl(method_impl_options.aggressive_inlining)>
        Friend Sub New(ByVal owner As hasharray(Of T, _UNIQUE, _HASHER, _EQUALER),
                       ByVal column As UInt32, ByVal row As UInt32)
