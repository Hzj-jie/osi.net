    ...
    Shared Sub New()
        bytes_serializer.fixed.register(Function(ByVal i As const_fast_pair(Of FT, ST), ByVal o As MemoryStream) As Boolean
                                        ...
                                        Function(ByVal i As MemoryStream, ByRef o As const_fast_pair(Of FT, ST)) As Boolean
                                            ...
                                            Return False
                                        End Function)
        json_serializer.register(Function(ByVal i As const_fast_pair(Of FT, ST), ByVal o As StringWriter) As Boolean
...
#End If
    ...
    Public Shared ReadOnly first_getter As Func(Of const_fast_pair(Of FT, ST), FT) =
        Function(ByVal p As const_fast_pair(Of FT, ST)) As FT
#If IS_CLASS Then
...
#End If
    ...
    Public Shared ReadOnly first_or_null_getter As Func(Of const_fast_pair(Of FT, ST), FT) =
        Function(ByVal p As const_fast_pair(Of FT, ST)) As FT
#If IS_CLASS Then
...
#End If
    ...
    Public Shared ReadOnly second_getter As Func(Of const_fast_pair(Of FT, ST), ST) =
        Function(ByVal p As const_fast_pair(Of FT, ST)) As ST
#If IS_CLASS Then
            assert(Not p Is Nothing)
#End If
            Return p.second
    ...
    Public Shared ReadOnly second_or_null_getter As Func(Of const_fast_pair(Of FT, ST), ST) =
        Function(ByVal p As const_fast_pair(Of FT, ST)) As ST
#If IS_CLASS Then
            If p Is Nothing Then
                Return Nothing
