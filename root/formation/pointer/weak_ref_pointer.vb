...
'with weak_ref_pointer.vbp ----------
'so change weak_ref_pointer.vbp instead of this file
...
Public Module _weak_ref_pointer
    ...
    <Extension()> Public Sub renew(Of T)(ByRef i As weak_ref_pointer(Of T))
...
'the following code is generated by /osi/root/codegen/precompile/precompile.exe
'with weak_ref_pointer.override.vbp ----------
'so change weak_ref_pointer.override.vbp instead of this file
...
#If Not (PocketPC OrElse Smartphone) Then
    Public Shared Operator ^(ByVal p As weak_ref_pointer(Of T), ByVal ji As Decimal) As Object
        ...
        While jumps > 0
            p2 = +(cast(Of weak_ref_pointer(Of T))(p2, False))
            jumps -= 1
        End While
finish:
        Return p2
