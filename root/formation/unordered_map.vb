...
Partial Public NotInheritable Class unordered_map(Of KEY_T, VALUE_T)
    ...
    Shared Sub New()
        ...
        container_operator(Of unordered_map(Of KEY_T, VALUE_T), first_const_pair(Of KEY_T, VALUE_T)).clear(
                Sub(ByVal i As unordered_map(Of KEY_T, VALUE_T))
                    ...
                    i.clear()
                End Sub)
        bytes_serializer(Of unordered_map(Of KEY_T, VALUE_T)).container(Of first_const_pair(Of KEY_T, VALUE_T)).
            register()
        json_serializer(Of unordered_map(Of KEY_T, VALUE_T)).container(Of first_const_pair(Of KEY_T, VALUE_T)).
            register_as_object()
        string_serializer(Of unordered_map(Of KEY_T, VALUE_T)).container(Of first_const_pair(Of KEY_T, VALUE_T)).
            register()
    End Sub
    ...
    'the following code is generated by /osi/root/codegen/precompile/precompile.exe
    'with ..\binary_tree\codegen\map.operators.vbp ----------
    'so change ..\binary_tree\codegen\map.operators.vbp instead of this file
    ...
    Public Shared Operator +(ByVal this As unordered_map(Of KEY_T, VALUE_T),
                             ByVal v As first_const_pair(Of KEY_T, VALUE_T)) as unordered_map(Of KEY_T, VALUE_T)

        assert(Not this Is Nothing)
        assert(this.insert(v).second)
        Return this
    End Operator
    'finish ..\binary_tree\codegen\map.operators.vbp --------
