...
Partial Public Class unordered_map(Of KEY_T,
    ...
    Public Overloads Function emplace(ByVal key As KEY_T, ByVal value As VALUE_T) As iterator
    ...
    Public Overloads Function insert(ByVal key As KEY_T, ByVal value As VALUE_T) As iterator
