...
'with tuple2.vbp ----------
'so change tuple2.vbp instead of this file
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CloneT() As tuple(Of T1, T2) _
                                Implements ICloneable(Of tuple(Of T1, T2)).Clone
#If 2 = 2 Then
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CompareTo(ByVal other As tuple(Of T1, T2)) As Int32 _
                             Implements IComparable(Of tuple(Of T1, T2)).CompareTo
        Dim r As Int32 = 0
...
#End If
    ...
    Public Function CompareTo(ByVal obj As Object) As Int32 Implements IComparable.CompareTo
        Return CompareTo(cast(Of tuple(Of T1, T2))(obj, False))
    End Function
