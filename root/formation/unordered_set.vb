...
'the following code is generated by /osi/root/codegen/precompile/precompile.exe
'with ..\binary_tree\codegen\set.operators.vbp ----------
'so change ..\binary_tree\codegen\set.operators.vbp instead of this file


    Public Shared Operator +(ByVal this As [unordered_set](Of T),
                             ByVal v As T) As [unordered_set](Of T)
        assert(this IsNot Nothing)
        assert(this.insert(v).second)
        Return this
    End Operator
'finish ..\binary_tree\codegen\set.operators.vbp --------
