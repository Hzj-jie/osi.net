...
'usually you do not need to use this codegen and the code generated unless it's in a very strict
...
#End If
        ...
        <MethodImpl(method_impl_options.aggressive_inlining)>
        Public Function CompareTo(ByVal other As adaptive_array_t) As Int32 _
            Implements IComparable(Of adaptive_array_t).CompareTo
