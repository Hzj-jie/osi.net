...
Partial Public Structure tuple(Of T1, T2, T3, T4)
    Implements ICloneable,
               ICloneable(Of tuple(Of T1, T2, T3, T4)),
               IComparable,
               IComparable(Of tuple(Of T1, T2, T3, T4)),
               IEquatable(Of tuple(Of T1, T2, T3, T4))
...
#End If
    ...
    Public Function EqualsT(ByVal that As tuple(Of T1, T2, T3, T4)) As Boolean _
                           Implements IEquatable(Of tuple(Of T1, T2, T3, T4)).EqualTo
