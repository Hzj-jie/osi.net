...
'with tuple4.vbp ----------
'so change tuple4.vbp instead of this file
...
#Else
Public Structure tuple(Of T1, T2, T3, T4)
#End If
    Implements ICloneable, ICloneable(Of tuple(Of T1, T2, T3, T4)),
               IComparable, IComparable(Of tuple(Of T1, T2, T3, T4))
...
#End If
    ...
    Public Function CloneT() As tuple(Of T1, T2, T3, T4) _
                                Implements ICloneable(Of tuple(Of T1, T2, T3, T4)).Clone
#If 4 = 3 Then
...
#End If
    ...
    Public Function CompareTo(ByVal other As tuple(Of T1, T2, T3, T4)) As Int32 _
                             Implements IComparable(Of tuple(Of T1, T2, T3, T4)).CompareTo
#If IS_CLASS Then
...
#End If
    ...
    Public Function CompareTo(ByVal obj As Object) As Int32 Implements IComparable.CompareTo
        Return CompareTo(cast(Of tuple(Of T1, T2, T3, T4))(obj, False))
    End Function

    Public Shared Operator =(ByVal this As tuple(Of T1, T2, T3, T4),
                             ByVal that As tuple(Of T1, T2, T3, T4)) As Boolean
...
' To reduce complexity, tuple is always const, use pointer if the fields are required to be muttable.
#If IS_CLASS Then
Public NotInheritable Class fast_tuple(Of T1, T2, T3, T4)
#Else
Public Structure fast_tuple(Of T1, T2, T3, T4)
#End If
    Implements ICloneable, ICloneable(Of fast_tuple(Of T1, T2, T3, T4)),
               IComparable, IComparable(Of fast_tuple(Of T1, T2, T3, T4))
...
#End If
    ...
    Public Function CloneT() As fast_tuple(Of T1, T2, T3, T4) _
                                Implements ICloneable(Of fast_tuple(Of T1, T2, T3, T4)).Clone
#If 4 = 3 Then
...
#End If
    ...
    Public Function CompareTo(ByVal other As fast_tuple(Of T1, T2, T3, T4)) As Int32 _
                             Implements IComparable(Of fast_tuple(Of T1, T2, T3, T4)).CompareTo
#If IS_CLASS Then
        If other Is Nothing Then
            Return 1
        End If
...
#End If
    ...
    Public Function CompareTo(ByVal obj As Object) As Int32 Implements IComparable.CompareTo
        Return CompareTo(cast(Of fast_tuple(Of T1, T2, T3, T4))(obj, False))
    End Function

    Public Shared Operator =(ByVal this As fast_tuple(Of T1, T2, T3, T4),
                             ByVal that As fast_tuple(Of T1, T2, T3, T4)) As Boolean
        Return compare(this, that) = 0
    End Operator
