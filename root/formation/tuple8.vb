...
Partial Public Structure tuple(Of T1, T2, T3, T4, T5, T6, T7, T8)
    Implements ICloneable,
               ICloneable(Of tuple(Of T1, T2, T3, T4, T5, T6, T7, T8)),
               IComparable,
               IComparable(Of tuple(Of T1, T2, T3, T4, T5, T6, T7, T8)),
               IEquatable(Of tuple(Of T1, T2, T3, T4, T5, T6, T7, T8))
...
#End If
    ...
    Public Function EqualsT(ByVal that As tuple(Of T1, T2, T3, T4, T5, T6, T7, T8)) As Boolean _
                           Implements IEquatable(Of tuple(Of T1, T2, T3, T4, T5, T6, T7, T8)).EqualTo
