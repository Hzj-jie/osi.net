...
#End If
    ...
    Shared Sub New()
        ...
        json_serializer.register(Function(ByVal i As pair(Of FT, ST), ByVal o As StringWriter) As Boolean
                                     ...
                                     Return True
                                 End Function)
        string_serializer.register(Function(ByVal i As pair(Of FT, ST), ByVal o As StringWriter) As Boolean
    ...
    Public NotInheritable Class first_hasher(Of _HASHER As _to_uint32(Of FT))
        Inherits _to_uint32(Of pair(Of FT, ST))

        Private Shared ReadOnly hasher As _HASHER = alloc(Of _HASHER)()

        Public Overrides Function at(ByRef k As pair(Of FT, ST)) As UInt32
            assert(Not k Is Nothing)
            Return hasher(k.first)
        End Function

        Public Overrides Function reverse(ByVal i As UInt32) As pair(Of FT, ST)
            assert(False)
            Return Nothing
        End Function
    End Class
    ...
    Public NotInheritable Class first_equaler(Of _EQUALER As _equaler(Of FT))
        Inherits _equaler(Of pair(Of FT, ST))

        Private Shared ReadOnly equaler As _EQUALER = alloc(Of _EQUALER)()

        Public Overrides Function at(ByRef i As pair(Of FT, ST),
                                     ByRef j As pair(Of FT, ST)) As Boolean
            Dim c As Int32
...
#End If
    ...
    Public Shared ReadOnly first_or_null_getter As Func(Of pair(Of FT, ST), FT) =
        Function(ByVal p As pair(Of FT, ST)) As FT
    ...
    Public Shared ReadOnly second_or_null_getter As Func(Of pair(Of FT, ST), ST) =
        Function(ByVal p As pair(Of FT, ST)) As ST
            If p Is Nothing Then
                Return Nothing
            End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function [of](ByVal first As FT, ByVal second As ST) As pair(Of FT, ST)
        Return New pair(Of FT, ST)(copy_no_error(first), copy_no_error(second))
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function [of](ByVal first As FT) As pair(Of FT, ST)
        Return [of](first, Nothing)
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function [of](ByVal second As ST) As pair(Of FT, ST)
        Return [of](Nothing, second)
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function [of]() As pair(Of FT, ST)
        Return [of](Nothing, Nothing)
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function emplace_of(ByVal first As FT, ByVal second As ST) As pair(Of FT, ST)
        Return New pair(Of FT, ST)(first, second)
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function emplace_of(ByVal first As FT) As pair(Of FT, ST)
        Return emplace_of(first, Nothing)
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function emplace_of(ByVal second As ST) As pair(Of FT, ST)
        Return emplace_of(Nothing, second)
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function emplace_of() As pair(Of FT, ST)
        Return emplace_of(Nothing, Nothing)
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function [of](ByVal i As KeyValuePair(Of FT, ST)) As pair(Of FT, ST)
        Return [of](i.Key(), i.Value())
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function emplace_of(ByVal i As KeyValuePair(Of FT, ST)) As pair(Of FT, ST)
