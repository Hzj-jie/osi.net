...
Partial Public Structure tuple(Of T1, T2, T3, T4, T5)
    Implements ICloneable,
               ICloneable(Of tuple(Of T1, T2, T3, T4, T5)),
               IComparable,
...
#End If
    ...
    Public Function EqualsT(ByVal that As tuple(Of T1, T2, T3, T4, T5)) As Boolean _
                           Implements IEquatable(Of tuple(Of T1, T2, T3, T4, T5)).EqualTo
