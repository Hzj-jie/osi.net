...
'with tuple5.vbp ----------
'so change tuple5.vbp instead of this file
...
#Else
Public Structure tuple(Of T1, T2, T3, T4, T5)
#End If
    Implements ICloneable, ICloneable(Of tuple(Of T1, T2, T3, T4, T5)),
               IComparable, IComparable(Of tuple(Of T1, T2, T3, T4, T5))
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CloneT() As tuple(Of T1, T2, T3, T4, T5) _
                                Implements ICloneable(Of tuple(Of T1, T2, T3, T4, T5)).Clone
#If 5 = 3 Then
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CompareTo(ByVal other As tuple(Of T1, T2, T3, T4, T5)) As Int32 _
                             Implements IComparable(Of tuple(Of T1, T2, T3, T4, T5)).CompareTo
#If IS_CLASS Then
...
#End If
    ...
    Public Function CompareTo(ByVal obj As Object) As Int32 Implements IComparable.CompareTo
        Return CompareTo(cast(Of tuple(Of T1, T2, T3, T4, T5))(obj, False))
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Operator =(ByVal this As tuple(Of T1, T2, T3, T4, T5),
                             ByVal that As tuple(Of T1, T2, T3, T4, T5)) As Boolean
...
' To reduce complexity, tuple is always const, use pointer if the fields are required to be muttable.
#If IS_CLASS Then
Public NotInheritable Class fast_tuple(Of T1, T2, T3, T4, T5)
#Else
Public Structure fast_tuple(Of T1, T2, T3, T4, T5)
#End If
    Implements ICloneable, ICloneable(Of fast_tuple(Of T1, T2, T3, T4, T5)),
               IComparable, IComparable(Of fast_tuple(Of T1, T2, T3, T4, T5))
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CloneT() As fast_tuple(Of T1, T2, T3, T4, T5) _
                                Implements ICloneable(Of fast_tuple(Of T1, T2, T3, T4, T5)).Clone
#If 5 = 3 Then
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CompareTo(ByVal other As fast_tuple(Of T1, T2, T3, T4, T5)) As Int32 _
                             Implements IComparable(Of fast_tuple(Of T1, T2, T3, T4, T5)).CompareTo
#If IS_CLASS Then
        If other Is Nothing Then
            Return 1
        End If
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CompareTo(ByVal obj As Object) As Int32 Implements IComparable.CompareTo
        Return CompareTo(cast(Of fast_tuple(Of T1, T2, T3, T4, T5))(obj, False))
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Operator =(ByVal this As fast_tuple(Of T1, T2, T3, T4, T5),
                             ByVal that As fast_tuple(Of T1, T2, T3, T4, T5)) As Boolean
        Return compare(this, that) = 0
    End Operator
