...
'so change tuple_make.vbp instead of this file
    ...
    Public Shared Function of_tuple _
                              (Of T1, T2, T3) _
                              (ByVal _1 As T1,
                               ByVal _2 As T2,
...
'so change tuple_make.vbp instead of this file
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function of_fast_tuple _
                              (Of T1, T2, T3) _
                              (ByVal _1 As T1,
                               ByVal _2 As T2,
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function [of_fast] _
                              (Of T1, T2, T3) _
                              (ByVal _1 As T1,
                               ByVal _2 As T2,
                               ByVal _3 As T3) As fast_tuple(Of T1, T2, T3)
...
'so change tuple_make.vbp instead of this file
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function emplace_of_fast_tuple _
                              (Of T1, T2, T3) _
                              (ByVal _1 As T1,
                               ByVal _2 As T2,
                               ByVal _3 As T3) As fast_tuple(Of T1, T2, T3)
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function [emplace_of_fast] _
                              (Of T1, T2, T3) _
                              (ByVal _1 As T1,
                               ByVal _2 As T2,
                               ByVal _3 As T3) As fast_tuple(Of T1, T2, T3)
...
'so change tuple_make.vbp instead of this file
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Function emplace_of_tuple _
                              (Of T1, T2, T3) _
                              (ByVal _1 As T1,
                               ByVal _2 As T2,
                               ByVal _3 As T3) As tuple(Of T1, T2, T3)
