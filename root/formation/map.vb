...
Public NotInheritable Class map(Of KEY_T, VALUE_T)
    ...
    Shared Sub New()
        container_operator(Of map(Of KEY_T, VALUE_T), first_const_pair(Of KEY_T, VALUE_T)).register(
                Function(ByVal i As map(Of KEY_T, VALUE_T)) As UInt32
                    assert(Not i Is Nothing)
                    Return i.size()
                End Function)
        container_operator.register(Function(ByVal i As map(Of KEY_T, VALUE_T),
                                             ByVal j As first_const_pair(Of KEY_T, VALUE_T)) As Boolean
                                        assert(Not i Is Nothing)
                                        Return i.emplace(j).second
                                    End Function)
        container_operator.register(Function(ByVal i As map(Of KEY_T, VALUE_T)) _
