...
#End If
    ...
    Shared Sub New()
        ...
        json_serializer.register(Function(ByVal i As const_pair(Of FT, ST), ByVal o As StringWriter) As Boolean
                                     ...
                                     Return True
                                 End Function)
        string_serializer.register(Function(ByVal i As const_pair(Of FT, ST), ByVal o As StringWriter) As Boolean
                                       ...
                                       Return True
                                   End Function,
                                   Function(ByVal sr As StringReader, ByRef o As const_pair(Of FT, ST)) As Boolean
...
#End If
    ...
    Public Shared ReadOnly first_comparer As Func(Of const_pair(Of FT, ST), const_pair(Of FT, ST), Int32) =
        Function(ByVal l As const_pair(Of FT, ST),
                 ByVal r As const_pair(Of FT, ST)) As Int32
            assert(Not l Is Nothing)
            assert(Not r Is Nothing)
            Return compare(l.first, r.first)
        End Function

    Public Shared ReadOnly second_comparer As Func(Of const_pair(Of FT, ST), const_pair(Of FT, ST), Int32) =
        Function(ByVal l As const_pair(Of FT, ST),
                 ByVal r As const_pair(Of FT, ST)) As Int32
            assert(Not l Is Nothing)
            assert(Not r Is Nothing)
    ...
    Public Shared ReadOnly second_first_comparer As Func(Of const_pair(Of FT, ST), const_pair(Of FT, ST), Int32) =
        Function(ByVal l As const_pair(Of FT, ST),
                 ByVal r As const_pair(Of FT, ST)) As Int32
            assert(Not l Is Nothing)
            assert(Not r Is Nothing)
...
#If Not IS_CONST AndAlso Not IS_FIRST_CONST Then
    ...
    Public Shared Function move(ByVal that As const_pair(Of FT, ST)) As const_pair(Of FT, ST)
        If that Is Nothing Then
            Return Nothing
        End If
        Dim r As New const_pair(Of FT, ST)()
        r.first = that.first
