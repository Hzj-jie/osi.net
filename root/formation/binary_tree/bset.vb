...
'so change set.container_operator.vbp instead of this file
    ...
    Shared Sub New()
        ...
        json_serializer(Of [bset](Of T)).container(Of T).register_as_array()
        string_serializer(Of [bset](Of T)).container(Of T).register()
    End Sub
...
'the following code is generated by /osi/root/codegen/precompile/precompile.exe
'with set.operators.vbp ----------
'so change set.operators.vbp instead of this file


    Public Shared Operator +(ByVal this As [bset](Of T),
                             ByVal v As T) As [bset](Of T)
        assert(Not this Is Nothing)
        assert(this.insert(v).second)
        Return this
    End Operator
'finish set.operators.vbp --------
