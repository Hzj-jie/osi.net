...
Public NotInheritable Class smap(Of KEY_T, VALUE_T)
    ...
    Implements ICloneable, ICloneable(Of smap(Of KEY_T, VALUE_T)),
               IEquatable(Of smap(Of KEY_T, VALUE_T))
    ...
    Shared Sub New()
        ...
        json_serializer(Of smap(Of KEY_T, VALUE_T)).container(Of first_const_pair(Of KEY_T, VALUE_T)).
            register_as_object()
    ...
    Public Function exclude(ByVal that As smap(Of KEY_T, VALUE_T)) As smap(Of KEY_T, VALUE_T)
        ...
        Dim r As New smap(Of KEY_T, VALUE_T)()
        Dim it As smap(Of KEY_T, VALUE_T).iterator = begin()
        While it <> [end]()
            Dim tit As smap(Of KEY_T, VALUE_T).iterator = that.find((+it).first)
