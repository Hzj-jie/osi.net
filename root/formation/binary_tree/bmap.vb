...
Public NotInheritable Class bmap(Of KEY_T, VALUE_T)
    ...
    Implements ICloneable, ICloneable(Of bmap(Of KEY_T, VALUE_T)),
               IEquatable(Of bmap(Of KEY_T, VALUE_T))
    ...
    Shared Sub New()
        container_operator(Of bmap(Of KEY_T, VALUE_T), first_const_pair(Of KEY_T, VALUE_T)).size(
                Function(ByVal i As bmap(Of KEY_T, VALUE_T)) As UInt32
                    ...
                    Return i.size()
                End Function)
        container_operator(Of bmap(Of KEY_T, VALUE_T), first_const_pair(Of KEY_T, VALUE_T)).emplace(
                Function(ByVal i As bmap(Of KEY_T, VALUE_T),
        ...
        json_serializer(Of bmap(Of KEY_T, VALUE_T)).container(Of first_const_pair(Of KEY_T, VALUE_T)).
            register_as_object()
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function first_mapper(Of KEY2_T)(ByVal f As Func(Of KEY_T, KEY2_T)) As _
            Func(Of first_const_pair(Of KEY_T, VALUE_T), first_const_pair(Of KEY2_T, VALUE_T))
        assert(Not f Is Nothing)
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function first_mapper(Of KEY2_T)(ByVal f As Func(Of KEY_T, VALUE_T, KEY2_T)) As _
            Func(Of first_const_pair(Of KEY_T, VALUE_T), first_const_pair(Of KEY2_T, VALUE_T))
        assert(Not f Is Nothing)
        Return Function(ByVal p As first_const_pair(Of KEY_T, VALUE_T)) As first_const_pair(Of KEY2_T, VALUE_T)
                   assert(Not p Is Nothing)
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function second_mapper(Of VALUE2_T)(ByVal f As Func(Of VALUE_T, VALUE2_T)) As _
            Func(Of first_const_pair(Of KEY_T, VALUE_T), first_const_pair(Of KEY_T, VALUE2_T))
        assert(Not f Is Nothing)
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function second_mapper(Of VALUE2_T)(ByVal f As Func(Of KEY_T, VALUE_T, VALUE2_T)) As _
            Func(Of first_const_pair(Of KEY_T, VALUE_T), first_const_pair(Of KEY_T, VALUE2_T))
        assert(Not f Is Nothing)
        Return Function(ByVal p As first_const_pair(Of KEY_T, VALUE_T)) As first_const_pair(Of KEY_T, VALUE2_T)
                   assert(Not p Is Nothing)
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function first_filter(ByVal f As Func(Of KEY_T, Boolean)) As _
            Func(Of first_const_pair(Of KEY_T, VALUE_T), Boolean)
        assert(Not f Is Nothing)
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function second_filter(ByVal f As Func(Of VALUE_T, Boolean)) As _
            Func(Of first_const_pair(Of KEY_T, VALUE_T), Boolean)
        assert(Not f Is Nothing)
        Return Function(ByVal i As first_const_pair(Of KEY_T, VALUE_T)) As Boolean
                   Return f(i.second)
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function mapper(Of R)(ByVal f As Func(Of KEY_T, VALUE_T, R)) As _
            Func(Of first_const_pair(Of KEY_T, VALUE_T), R)
        assert(Not f Is Nothing)
    ...
    ' Returns a new bmap containing all pairs in Me but not in that,
    ' including unequal values.
    Public Function exclude(ByVal that As bmap(Of KEY_T, VALUE_T)) As bmap(Of KEY_T, VALUE_T)
        ...
        Dim it As bmap(Of KEY_T, VALUE_T).iterator = Nothing
        it = begin()
        While it <> [end]()
            Dim tit As bmap(Of KEY_T, VALUE_T).iterator = Nothing
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Overloads Function Equals(ByVal that As bmap(Of KEY_T, VALUE_T)) As Boolean _
            Implements IEquatable(Of bmap(Of KEY_T, VALUE_T)).Equals
        If that Is Nothing OrElse that.empty() Then
            Return empty()
        End If
    ...
    Public Overrides Function Equals(ByVal that As Object) As Boolean
        Return Equals(cast(Of bmap(Of KEY_T, VALUE_T))(that, False))
    End Function
    ...
    Public Shared Operator +(ByVal this As bmap(Of KEY_T, VALUE_T),
                             ByVal v As first_const_pair(Of KEY_T, VALUE_T)) as bmap(Of KEY_T, VALUE_T)
