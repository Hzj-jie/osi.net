...
Public Class [set](Of T)
    ...
    Shared Sub New()
        container_operator(Of [set](Of T), T).register(Function(ByVal i As [set](Of T)) As UInt32
                                                           assert(Not i Is Nothing)
                                                           Return i.size()
                                                       End Function)
        container_operator(Of [set](Of T), T).register(Function(ByVal i As [set](Of T), ByVal j As T) As Boolean
                                                           assert(Not i Is Nothing)
                                                           Return i.emplace(j).second
                                                       End Function)
        container_operator(Of [set](Of T), T).register(Function(ByVal i As [set](Of T)) _
