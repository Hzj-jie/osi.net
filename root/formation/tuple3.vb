...
' To reduce complexity, tuple is always const, use pointer if the fields are required to be muttable.
#If IS_CLASS Then
Public NotInheritable Class fast_tuple(Of T1, T2, T3)
#Else
Public Structure fast_tuple(Of T1, T2, T3)
#End If
    Implements ICloneable, ICloneable(Of fast_tuple(Of T1, T2, T3)),
               IComparable, IComparable(Of fast_tuple(Of T1, T2, T3))
