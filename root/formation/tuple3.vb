...
'with tuple3.vbp ----------
'so change tuple3.vbp instead of this file
...
Partial Public Structure tuple(Of T1, T2, T3)
    Implements ICloneable,
               ICloneable(Of tuple(Of T1, T2, T3)),
               IComparable,
               IComparable(Of tuple(Of T1, T2, T3)),
               IEquatable(Of tuple(Of T1, T2, T3))
...
#End If
    ...
    Public Function EqualsT(ByVal that As tuple(Of T1, T2, T3)) As Boolean _
                           Implements IEquatable(Of tuple(Of T1, T2, T3)).EqualTo
