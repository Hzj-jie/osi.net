...
Partial Public Structure tuple(Of T1, T2, T3, T4, T5, T6)
    Implements ICloneable,
               ICloneable(Of tuple(Of T1, T2, T3, T4, T5, T6)),
               IComparable,
               IComparable(Of tuple(Of T1, T2, T3, T4, T5, T6)),
               IEquatable(Of tuple(Of T1, T2, T3, T4, T5, T6))
...
#End If
    ...
    Public Function EqualsT(ByVal that As tuple(Of T1, T2, T3, T4, T5, T6)) As Boolean _
                           Implements IEquatable(Of tuple(Of T1, T2, T3, T4, T5, T6)).EqualTo
