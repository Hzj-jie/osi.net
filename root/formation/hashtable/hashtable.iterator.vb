...
'so change ..\..\codegen\iterator.ext.vbp instead of this file
    ...
    <Extension()> Public Function null_or_end(Of T, _UNIQUE As _boolean, _HASHER As _to_uint32(Of T), _COMPARER As _comparer(Of T))(ByVal this As hashtable(Of T, _UNIQUE, _HASHER, _COMPARER).iterator) As Boolean
