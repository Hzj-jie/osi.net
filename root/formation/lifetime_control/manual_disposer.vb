...
'with manual_disposer.vbp ----------
'so change manual_disposer.vbp instead of this file


' Do not use, this class provides very limited functionalities. Use once_action
' or dispose_ptr<>.
