...
#Else
Public Structure tuple(Of T1, T2, T3, T4, T5, T6, T7)
#End If
...
' To reduce complexity, tuple is always const, use pointer if the fields are required to be muttable.
#If IS_CLASS Then
Public NotInheritable Class fast_tuple(Of T1, T2, T3, T4, T5, T6, T7)
#Else
Public Structure fast_tuple(Of T1, T2, T3, T4, T5, T6, T7)
#End If
    Implements ICloneable, ICloneable(Of fast_tuple(Of T1, T2, T3, T4, T5, T6, T7)),
               IComparable, IComparable(Of fast_tuple(Of T1, T2, T3, T4, T5, T6, T7))
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CloneT() As fast_tuple(Of T1, T2, T3, T4, T5, T6, T7) _
                                Implements ICloneable(Of fast_tuple(Of T1, T2, T3, T4, T5, T6, T7)).Clone
#If 7 = 3 Then
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CompareTo(ByVal other As fast_tuple(Of T1, T2, T3, T4, T5, T6, T7)) As Int32 _
                             Implements IComparable(Of fast_tuple(Of T1, T2, T3, T4, T5, T6, T7)).CompareTo
#If IS_CLASS Then
        If other Is Nothing Then
            Return 1
        End If
...
#End If
    ...
    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Function CompareTo(ByVal obj As Object) As Int32 Implements IComparable.CompareTo
        Return CompareTo(cast(Of fast_tuple(Of T1, T2, T3, T4, T5, T6, T7))(obj, False))
    End Function

    <MethodImpl(method_impl_options.aggressive_inlining)>
    Public Shared Operator =(ByVal this As fast_tuple(Of T1, T2, T3, T4, T5, T6, T7),
                             ByVal that As fast_tuple(Of T1, T2, T3, T4, T5, T6, T7)) As Boolean
        Return compare(this, that) = 0
    End Operator
